/**
 * Fractal Categories Index
 * Modular exports for all fractal categories
 */

export { GEOMETRIC_CURVES } from './geometricCurves';
export { CONSTRUCTIVE_FRACTALS } from './constructiveFractals';
