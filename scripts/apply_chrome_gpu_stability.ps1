...
# WARNING: These settings conflict with games (PUBG, etc.)!
# - TDR Delay 60s causes VRAM exhaustion in games
# - Use C:\agent-shield\scripts\fix-pubg-vram.ps1 to fix before gaming
# - Use C:\agent-shield\scripts\game-mode.ps1 before launching games
