 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Qp;function Um(){return Qp||(Qp=1,(function(p){function s(w,q){var T=w.length;w.push(q);e:for(;0<T;){var V=T-1>>>1,W=w[V];if(0<g(W,q))w[V]=q,w[T]=W,T=V;else break e}}function f(w){return w.length===0?null:w[0]}function u(w){if(w.length===0)return null;var q=w[0],T=w.pop();if(T!==q){w[0]=T;e:for(var V=0,W=w.length,m=W>>>1;V<m;){var C=2*(V+1)-1,H=w[C],X=C+1,ae=w[X];if(0>g(H,T))X<W&&0>g(ae,H)?(w[V]=ae,w[X]=T,V=X):(w[V]=H,w[C]=T,V=C);else if(X<W&&0>g(ae,T))w[V]=ae,w[X]=T,V=X;else break e}}return q}function g(w,q){var T=w.sortIndex-q.sortIndex;return T!==0?T:w.id-q.id}if(p.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var b=performance;p.unstable_now=function(){return b.now()}}else{var x=Date,j=x.now();p.unstable_now=function(){return x.now()-j}}var D=[],v=[],F=1,E=null,L=3,U=!1,P=!1,K=!1,I=!1,B=typeof setTimeout=="function"?setTimeout:null,ce=typeof clearTimeout=="function"?clearTimeout:null,_=typeof setImmediate<"u"?setImmediate:null;function Y(w){for(var q=f(v);q!==null;){if(q.callback===null)u(v);else if(q.startTime<=w)u(v),q.sortIndex=q.expirationTime,s(D,q);else break;q=f(v)}}function he(w){if(K=!1,Y(w),!P)if(f(D)!==null)P=!0,De||(De=!0,He());else{var q=f(v);q!==null&&oe(he,q.startTime-w)}}var De=!1,ee=-1,Ce=5,Fe=-1;function Ue(){return I?!0:!(p.unstable_now()-Fe<Ce)}function Xe(){if(I=!1,De){var w=p.unstable_now();Fe=w;var q=!0;try{e:{P=!1,K&&(K=!1,ce(ee),ee=-1),U=!0;var T=L;try{t:{for(Y(w),E=f(D);E!==null&&!(E.expirationTime>w&&Ue());){var V=E.callback;if(typeof V=="function"){E.callback=null,L=E.priorityLevel;var W=V(E.expirationTime<=w);if(w=p.unstable_now(),typeof W=="function"){E.callback=W,Y(w),q=!0;break t}E===f(D)&&u(D),Y(w)}else u(D);E=f(D)}if(E!==null)q=!0;else{var m=f(v);m!==null&&oe(he,m.startTime-w),q=!1}}break e}finally{E=null,L=T,U=!1}q=void 0}}finally{q?He():De=!1}}}var He;if(typeof _=="function")He=function(){_(Xe)};else if(typeof MessageChannel<"u"){var ue=new MessageChannel,qe=ue.port2;ue.port1.onmessage=Xe,He=function(){qe.postMessage(null)}}else He=function(){B(Xe,0)};function oe(w,q){ee=B(function(){w(p.unstable_now())},q)}p.unstable_IdlePriority=5,p.unstable_ImmediatePriority=1,p.unstable_LowPriority=4,p.unstable_NormalPriority=3,p.unstable_Profiling=null,p.unstable_UserBlockingPriority=2,p.unstable_cancelCallback=function(w){w.callback=null},p.unstable_forceFrameRate=function(w){0>w||125<w?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Ce=0<w?Math.floor(1e3/w):5},p.unstable_getCurrentPriorityLevel=function(){return L},p.unstable_next=function(w){switch(L){case 1:case 2:case 3:var q=3;break;default:q=L}var T=L;L=q;try{return w()}finally{L=T}},p.unstable_requestPaint=function(){I=!0},p.unstable_runWithPriority=function(w,q){switch(w){case 1:case 2:case 3:case 4:case 5:break;default:w=3}var T=L;L=w;try{return q()}finally{L=T}},p.unstable_scheduleCallback=function(w,q,T){var V=p.unstable_now();switch(typeof T=="object"&&T!==null?(T=T.delay,T=typeof T=="number"&&0<T?V+T:V):T=V,w){case 1:var W=-1;break;case 2:W=250;break;case 5:W=1073741823;break;case 4:W=1e4;break;default:W=5e3}return W=T+W,w={id:F++,callback:q,priorityLevel:w,startTime:T,expirationTime:W,sortIndex:-1},T>V?(w.sortIndex=T,s(v,w),f(D)===null&&w===f(v)&&(K?(ce(ee),ee=-1):K=!0,oe(he,T-V))):(w.sortIndex=W,s(D,w),P||U||(P=!0,De||(De=!0,He()))),w},p.unstable_shouldYield=Ue,p.unstable_wrapCallback=function(w){var q=L;return function(){var T=L;L=q;try{return w.apply(this,arguments)}finally{L=T}}}})(Vs)),Vs}var Kp;function Bm(){return Kp||(Kp=1,Xs.exports=Um()),Xs.exports}var Zs={exports:{}},ie={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
