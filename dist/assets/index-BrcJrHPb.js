 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Qp;function Um(){return Qp||(Qp=1,(function(p){function s(D,q){var T=D.length;D.push(q);e:for(;0<T;){var V=T-1>>>1,ee=D[V];if(0<v(ee,q))D[V]=q,D[T]=ee,T=V;else break e}}function d(D){return D.length===0?null:D[0]}function u(D){if(D.length===0)return null;var q=D[0],T=D.pop();if(T!==q){D[0]=T;e:for(var V=0,ee=D.length,m=ee>>>1;V<m;){var R=2*(V+1)-1,G=D[R],X=R+1,ne=D[X];if(0>v(G,T))X<ee&&0>v(ne,G)?(D[V]=ne,D[X]=T,V=X):(D[V]=G,D[R]=T,V=R);else if(X<ee&&0>v(ne,T))D[V]=ne,D[X]=T,V=X;else break e}}return q}function v(D,q){var T=D.sortIndex-q.sortIndex;return T!==0?T:D.id-q.id}if(p.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var b=performance;p.unstable_now=function(){return b.now()}}else{var x=Date,A=x.now();p.unstable_now=function(){return x.now()-A}}var N=[],g=[],F=1,E=null,L=3,U=!1,Y=!1,J=!1,W=!1,B=typeof setTimeout=="function"?setTimeout:null,ce=typeof clearTimeout=="function"?clearTimeout:null,_=typeof setImmediate<"u"?setImmediate:null;function P(D){for(var q=d(g);q!==null;){if(q.callback===null)u(g);else if(q.startTime<=D)u(g),q.sortIndex=q.expirationTime,s(N,q);else break;q=d(g)}}function me(D){if(J=!1,P(D),!Y)if(d(N)!==null)Y=!0,Ne||(Ne=!0,Be());else{var q=d(g);q!==null&&K(me,q.startTime-D)}}var Ne=!1,te=-1,Me=5,Ee=-1;function qe(){return W?!0:!(p.unstable_now()-Ee<Me)}function Ye(){if(W=!1,Ne){var D=p.unstable_now();Ee=D;var q=!0;try{e:{Y=!1,J&&(J=!1,ce(te),te=-1),U=!0;var T=L;try{t:{for(P(D),E=d(N);E!==null&&!(E.expirationTime>D&&qe());){var V=E.callback;if(typeof V=="function"){E.callback=null,L=E.priorityLevel;var ee=V(E.expirationTime<=D);if(D=p.unstable_now(),typeof ee=="function"){E.callback=ee,P(D),q=!0;break t}E===d(N)&&u(N),P(D)}else u(N);E=d(N)}if(E!==null)q=!0;else{var m=d(g);m!==null&&K(me,m.startTime-D),q=!1}}break e}finally{E=null,L=T,U=!1}q=void 0}}finally{q?Be():Ne=!1}}}var Be;if(typeof _=="function")Be=function(){_(Ye)};else if(typeof MessageChannel<"u"){var et=new MessageChannel,tt=et.port2;et.port1.onmessage=Ye,Be=function(){tt.postMessage(null)}}else Be=function(){B(Ye,0)};function K(D,q){te=B(function(){D(p.unstable_now())},q)}p.unstable_IdlePriority=5,p.unstable_ImmediatePriority=1,p.unstable_LowPriority=4,p.unstable_NormalPriority=3,p.unstable_Profiling=null,p.unstable_UserBlockingPriority=2,p.unstable_cancelCallback=function(D){D.callback=null},p.unstable_forceFrameRate=function(D){0>D||125<D?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Me=0<D?Math.floor(1e3/D):5},p.unstable_getCurrentPriorityLevel=function(){return L},p.unstable_next=function(D){switch(L){case 1:case 2:case 3:var q=3;break;default:q=L}var T=L;L=q;try{return D()}finally{L=T}},p.unstable_requestPaint=function(){W=!0},p.unstable_runWithPriority=function(D,q){switch(D){case 1:case 2:case 3:case 4:case 5:break;default:D=3}var T=L;L=D;try{return q()}finally{L=T}},p.unstable_scheduleCallback=function(D,q,T){var V=p.unstable_now();switch(typeof T=="object"&&T!==null?(T=T.delay,T=typeof T=="number"&&0<T?V+T:V):T=V,D){case 1:var ee=-1;break;case 2:ee=250;break;case 5:ee=1073741823;break;case 4:ee=1e4;break;default:ee=5e3}return ee=T+ee,D={id:F++,callback:q,priorityLevel:D,startTime:T,expirationTime:ee,sortIndex:-1},T>V?(D.sortIndex=T,s(g,D),d(N)===null&&D===d(g)&&(J?(ce(te),te=-1):J=!0,K(me,T-V))):(D.sortIndex=ee,s(N,D),Y||U||(Y=!0,Ne||(Ne=!0,Be()))),D},p.unstable_shouldYield=qe,p.unstable_wrapCallback=function(D){var q=L;return function(){var T=L;L=q;try{return D.apply(this,arguments)}finally{L=T}}}})(Vs)),Vs}var Kp;function Bm(){return Kp||(Kp=1,Xs.exports=Um()),Xs.exports}var Zs={exports:{}},ie={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Jp;function Lm(){if(Jp)return ie;Jp=1;var p=Symbol.for("react.transitional.element"),s=Symbol.for("react.portal"),d=Symbol.for("react.fragment"),u=Symbol.for("react.strict_mode"),v=Symbol.for("react.profiler"),b=Symbol.for("react.consumer"),x=Symbol.for("react.context"),A=Symbol.for("react.forward_ref"),N=Symbol.for("react.suspense"),g=Symbol.for("react.memo"),F=Symbol.for("react.lazy"),E=Symbol.for("react.activity"),L=Symbol.iterator;function U(m){return m===null||typeof m!="object"?null:(m=L&&m[L]||m["@@iterator"],typeof m=="function"?m:null)}var Y={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},J=Object.assign,W={};function B(m,R,G){this.props=m,this.context=R,this.refs=W,this.updater=G||Y}B.prototype.isReactComponent={},B.prototype.setState=function(m,R){if(typeof m!="object"&&typeof m!="function"&&m!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,m,R,"setState")},B.prototype.forceUpdate=function(m){this.updater.enqueueForceUpdate(this,m,"forceUpdate")};function ce(){}ce.prototype=B.prototype;function _(m,R,G){this.props=m,this.context=R,this.refs=W,this.updater=G||Y}var P=_.prototype=new ce;P.constructor=_,J(P,B.prototype),P.isPureReactComponent=!0;var me=Array.isArray;function Ne(){}var te={H:null,A:null,T:null,S:null},Me=Object.prototype.hasOwnProperty;function Ee(m,R,G){var X=G.ref;return{$$typeof:p,type:m,key:R,ref:X!==void 0?X:null,props:G}}function qe(m,R){return Ee(m.type,R,m.props)}function Ye(m){return typeof m=="object"&&m!==null&&m.$$typeof===p}function Be(m){var R={"=":"=0",":":"=2"};return"$"+m.replace(/[=:]/g,function(G){return R[G]})}var et=/\/+/g;function tt(m,R){return typeof m=="object"&&m!==null&&m.key!=null?Be(""+m.key):R.toString(36)}function K(m){switch(m.status){case"fulfilled":return m.value;case"rejected":throw m.reason;default:switch(typeof m.status=="string"?m.then(Ne,Ne):(m.status="pending",m.then(function(R){m.status==="pending"&&(m.status="fulfilled",m.value=R)},function(R){m.status==="pending"&&(m.status="rejected",m.reason=R)})),m.status){case"fulfilled":return m.value;case"rejected":throw m.reason}}throw m}function D(m,R,G,X,ne){var le=typeof m;(le==="undefined"||le==="boolean")&&(m=null);var pe=!1;if(m===null)pe=!0;else switch(le){case"bigint":case"string":case"number":pe=!0;break;case"object":switch(m.$$typeof){case p:case s:pe=!0;break;case F:return pe=m._init,D(pe(m._payload),R,G,X,ne)}}if(pe)return ne=ne(m),pe=X===""?"."+tt(m,0):X,me(ne)?(G="",pe!=null&&(G=pe.replace(et,"$&/")+"/"),D(ne,R,G,"",function(la){return la})):ne!=null&&(Ye(ne)&&(ne=qe(ne,G+(ne.key==null||m&&m.key===ne.key?"":(""+ne.key).replace(et,"$&/")+"/")+pe)),R.push(ne)),1;pe=0;var Qe=X===""?".":X+":";if(me(m))for(var _e=0;_e<m.length;_e++)X=m[_e],le=Qe+tt(X,_e),pe+=D(X,R,G,le,ne);else if(_e=U(m),typeof _e=="function")for(m=_e.call(m),_e=0;!(X=m.next()).done;)X=X.value,le=Qe+tt(X,_e++),pe+=D(X,R,G,le,ne);else if(le==="object"){if(typeof m.then=="function")return D(K(m),R,G,X,ne);throw R=String(m),Error("Objects are not valid as a React child (found: "+(R==="[object Object]"?"object with keys {"+Object.keys(m).join(", ")+"}":R)+"). If you meant to render a collection of children, use an array instead.")}return pe}function q(m,R,G){if(m==null)return m;var X=[],ne=0;return D(m,X,"","",function(le){return R.call(G,le,ne++)}),X}function T(m){if(m._status===-1){var R=m._result;R=R(),R.then(function(G){(m._status===0||m._status===-1)&&(m._status=1,m._result=G)},function(G){(m._status===0||m._status===-1)&&(m._status=2,m._result=G)}),m._status===-1&&(m._status=0,m._result=R)}if(m._status===1)return m._result.default;throw m._result}var V=typeof reportError=="function"?reportError:function(m){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var R=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof m=="object"&&m!==null&&typeof m.message=="string"?String(m.message):String(m),error:m});if(!window.dispatchEvent(R))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",m);return}console.error(m)},ee={map:q,forEach:function(m,R,G){q(m,function(){R.apply(this,arguments)},G)},count:function(m){var R=0;return q(m,function(){R++}),R},toArray:function(m){return q(m,function(R){return R})||[]},only:function(m){if(!Ye(m))throw Error("React.Children.only expected to receive a single React element child.");return m}};return ie.Activity=E,ie.Children=ee,ie.Component=B,ie.Fragment=d,ie.Profiler=v,ie.PureComponent=_,ie.StrictMode=u,ie.Suspense=N,ie.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=te,ie.__COMPILER_RUNTIME={__proto__:null,c:function(m){return te.H.useMemoCache(m)}},ie.cache=function(m){return function(){return m.apply(null,arguments)}},ie.cacheSignal=function(){return null},ie.cloneElement=function(m,R,G){if(m==null)throw Error("The argument must be a React element, but you passed "+m+".");var X=J({},m.props),ne=m.key;if(R!=null)for(le in R.key!==void 0&&(ne=""+R.key),R)!Me.call(R,le)||le==="key"||le==="__self"||le==="__source"||le==="ref"&&R.ref===void 0||(X[le]=R[le]);var le=arguments.length-2;if(le===1)X.children=G;else if(1<le){for(var pe=Array(le),Qe=0;Qe<le;Qe++)pe[Qe]=arguments[Qe+2];X.children=pe}return Ee(m.type,ne,X)},ie.createContext=function(m){return m={$$typeof:x,_currentValue:m,_currentValue2:m,_threadCount:0,Provider:null,Consumer:null},m.Provider=m,m.Consumer={$$typeof:b,_context:m},m},ie.createElement=function(m,R,G){var X,ne={},le=null;if(R!=null)for(X in R.key!==void 0&&(le=""+R.key),R)Me.call(R,X)&&X!=="key"&&X!=="__self"&&X!=="__source"&&(ne[X]=R[X]);var pe=arguments.length-2;if(pe===1)ne.children=G;else if(1<pe){for(var Qe=Array(pe),_e=0;_e<pe;_e++)Qe[_e]=arguments[_e+2];ne.children=Qe}if(m&&m.defaultProps)for(X in pe=m.defaultProps,pe)ne[X]===void 0&&(ne[X]=pe[X]);return Ee(m,le,ne)},ie.createRef=function(){return{current:null}},ie.forwardRef=function(m){return{$$typeof:A,render:m}},ie.isValidElement=Ye,ie.lazy=function(m){return{$$typeof:F,_payload:{_status:-1,_result:m},_init:T}},ie.memo=function(m,R){return{$$typeof:g,type:m,compare:R===void 0?null:R}},ie.startTransition=function(m){var R=te.T,G={};te.T=G;try{var X=m(),ne=te.S;ne!==null&&ne(G,X),typeof X=="object"&&X!==null&&typeof X.then=="function"&&X.then(Ne,V)}catch(le){V(le)}finally{R!==null&&G.types!==null&&(R.types=G.types),te.T=R}},ie.unstable_useCacheRefresh=function(){return te.H.useCacheRefresh()},ie.use=function(m){return te.H.use(m)},ie.useActionState=function(m,R,G){return te.H.useActionState(m,R,G)},ie.useCallback=function(m,R){return te.H.useCallback(m,R)},ie.useContext=function(m){return te.H.useContext(m)},ie.useDebugValue=function(){},ie.useDeferredValue=function(m,R){return te.H.useDeferredValue(m,R)},ie.useEffect=function(m,R){return te.H.useEffect(m,R)},ie.useEffectEvent=function(m){return te.H.useEffectEvent(m)},ie.useId=function(){return te.H.useId()},ie.useImperativeHandle=function(m,R,G){return te.H.useImperativeHandle(m,R,G)},ie.useInsertionEffect=function(m,R){return te.H.useInsertionEffect(m,R)},ie.useLayoutEffect=function(m,R){return te.H.useLayoutEffect(m,R)},ie.useMemo=function(m,R){return te.H.useMemo(m,R)},ie.useOptimistic=function(m,R){return te.H.useOptimistic(m,R)},ie.useReducer=function(m,R,G){return te.H.useReducer(m,R,G)},ie.useRef=function(m){return te.H.useRef(m)},ie.useState=function(m){return te.H.useState(m)},ie.useSyncExternalStore=function(m,R,G){return te.H.useSyncExternalStore(m,R,G)},ie.useTransition=function(){return te.H.useTransition()},ie.version="19.2.8",ie}var Wp;function Is(){return Wp||(Wp=1,Zs.exports=Lm()),Zs.exports}var Qs={exports:{}},yt={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var $p;function Gm(){if($p)return yt;$p=1;var p=Is();function s(N){var g="https://react.dev/errors/"+N;if(1<arguments.length){g+="?args[]="+encodeURIComponent(arguments[1]);for(var F=2;F<arguments.length;F++)g+="&args[]="+encodeURIComponent(arguments[F])}return"Minified React error #"+N+"; visit "+g+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function d(){}var u={d:{f:d,r:function(){throw Error(s(522))},D:d,C:d,L:d,m:d,X:d,S:d,M:d},p:0,findDOMNode:null},v=Symbol.for("react.portal");function b(N,g,F){var E=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:v,key:E==null?null:""+E,children:N,containerInfo:g,implementation:F}}var x=p.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function A(N,g){if(N==="font")return"";if(typeof g=="string")return g==="use-credentials"?g:""}return yt.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=u,yt.createPortal=function(N,g){var F=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!g||g.nodeType!==1&&g.nodeType!==9&&g.nodeType!==11)throw Error(s(299));return b(N,g,null,F)},yt.flushSync=function(N){var g=x.T,F=u.p;try{if(x.T=null,u.p=2,N)return N()}finally{x.T=g,u.p=F,u.d.f()}},yt.preconnect=function(N,g){typeof N=="string"&&(g?(g=g.crossOrigin,g=typeof g=="string"?g==="use-credentials"?g:"":void 0):g=null,u.d.C(N,g))},yt.prefetchDNS=function(N){typeof N=="string"&&u.d.D(N)},yt.preinit=function(N,g){if(typeof N=="string"&&g&&typeof g.as=="string"){var F=g.as,E=A(F,g.crossOrigin),L=typeof g.integrity=="string"?g.integrity:void 0,U=typeof g.fetchPriority=="string"?g.fetchPriority:void 0;F==="style"?u.d.S(N,typeof g.precedence=="string"?g.precedence:void 0,{crossOrigin:E,integrity:L,fetchPriority:U}):F==="script"&&u.d.X(N,{crossOrigin:E,integrity:L,fetchPriority:U,nonce:typeof g.nonce=="string"?g.nonce:void 0})}},yt.preinitModule=function(N,g){if(typeof N=="string")if(typeof g=="object"&&g!==null){if(g.as==null||g.as==="script"){var F=A(g.as,g.crossOrigin);u.d.M(N,{crossOrigin:F,integrity:typeof g.integrity=="string"?g.integrity:void 0,nonce:typeof g.nonce=="string"?g.nonce:void 0})}}else g==null&&u.d.M(N)},yt.preload=function(N,g){if(typeof N=="string"&&typeof g=="object"&&g!==null&&typeof g.as=="string"){var F=g.as,E=A(F,g.crossOrigin);u.d.L(N,F,{crossOrigin:E,integrity:typeof g.integrity=="string"?g.integrity:void 0,nonce:typeof g.nonce=="string"?g.nonce:void 0,type:typeof g.type=="string"?g.type:void 0,fetchPriority:typeof g.fetchPriority=="string"?g.fetchPriority:void 0,referrerPolicy:typeof g.referrerPolicy=="string"?g.referrerPolicy:void 0,imageSrcSet:typeof g.imageSrcSet=="string"?g.imageSrcSet:void 0,imageSizes:typeof g.imageSizes=="string"?g.imageSizes:void 0,media:typeof g.media=="string"?g.media:void 0})}},yt.preloadModule=function(N,g){if(typeof N=="string")if(g){var F=A(g.as,g.crossOrigin);u.d.m(N,{as:typeof g.as=="string"&&g.as!=="script"?g.as:void 0,crossOrigin:F,integrity:typeof g.integrity=="string"?g.integrity:void 0})}else u.d.m(N)},yt.requestFormReset=function(N){u.d.r(N)},yt.unstable_batchedUpdates=function(N,g){return N(g)},yt.useFormState=function(N,g,F){return x.H.useFormState(N,g,F)},yt.useFormStatus=function(){return x.H.useHostTransitionStatus()},yt.version="19.2.8",yt}var Ip;function Hm(){if(Ip)return Qs.exports;Ip=1;function p(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(p)}catch(s){console.error(s)}}return p(),Qs.exports=Gm(),Qs.exports}/**
 * @license React
...
`,nh=ah;class ih extends pd{constructor(s){super(s),this.gl=null,this.program=null,this.vao=null,this.vbo=null,this.uniformLocs={},this.rendererInfo="WebGL2 Shader Pipeline"}init(){console.group("[WebGL2] === INITIALIZATION START ==="),console.info("[WebGL2] Canvas element:",this.canvas),console.info("[WebGL2] Canvas size (CSS):",this.canvas.clientWidth,"x",this.canvas.clientHeight),console.info("[WebGL2] Canvas size (buffer):",this.canvas.width,"x",this.canvas.height),console.info("[WebGL2] User Agent:",navigator.userAgent),console.info("[WebGL2] Device Pixel Ratio:",window.devicePixelRatio);const s=this.canvas.getBoundingClientRect();(s.width===0||s.height===0)&&(console.warn("[WebGL2] Canvas has zero dimensions, setting fallback size..."),this.canvas.width=Math.max(1,this.canvas.clientWidth||800),this.canvas.height=Math.max(1,this.canvas.clientHeight||600)),console.info('[WebGL2] Attempt 1: getContext("webgl2") with no options...');let d=this.canvas.getContext("webgl2");if(console.info("[WebGL2] Result:",d?"SUCCESS":"FAILED"),d||(console.info("[WebGL2] Attempt 2: webgl2 with preserveDrawingBuffer..."),d=this.canvas.getContext("webgl2",{alpha:!1,antialias:!1,powerPreference:"high-performance",preserveDrawingBuffer:!0}),console.info("[WebGL2] Result:",d?"SUCCESS":"FAILED")),d||(console.info("[WebGL2] Attempt 3: webgl2 with high-performance..."),d=this.canvas.getContext("webgl2",{alpha:!1,antialias:!1,powerPreference:"high-performance"}),console.info("[WebGL2] Result:",d?"SUCCESS":"FAILED")),!d){console.warn("[WebGL2] All webgl2 attempts failed, trying webgl (WebGL1)...");const F=this.canvas.getContext("webgl")||this.canvas.getContext("experimental-webgl");return F&&(console.error("[WebGL2] WebGL1 obtained but WebGL2 is required. Check chrome://gpu"),console.error("[WebGL2] WebGL1 renderer:",F.getParameter(F.RENDERER))),console.error("[WebGL2] === INITIALIZATION FAILED ==="),console.groupEnd(),!1}this.gl=d,console.info("[WebGL2] Context acquired!"),console.info("[WebGL2] GL_VERSION:",d.getParameter(d.VERSION)),console.info("[WebGL2] GL_RENDERER:",d.getParameter(d.RENDERER)),console.info("[WebGL2] GL_VENDOR:",d.getParameter(d.VENDOR)),console.info("[WebGL2] GL_SHADING_LANGUAGE_VERSION:",d.getParameter(d.SHADING_LANGUAGE_VERSION));const u=d.getSupportedExtensions();console.info("[WebGL2] Supported extensions count:",(u==null?void 0:u.length)||0),console.info("[WebGL2] KHR_parallel_shader_compile:",u==null?void 0:u.includes("KHR_parallel_shader_compile")),console.info("[WebGL2] WEBGL_debug_renderer_info:",u==null?void 0:u.includes("WEBGL_debug_renderer_info"));try{const F=d.getExtension("WEBGL_debug_renderer_info");if(F){const E=d.getParameter(F.UNMASKED_RENDERER_WEBGL);E&&(this.rendererInfo=E)}}catch{this.rendererInfo="WebGL2 Hardware Engine"}const v=this.compileShader(d.VERTEX_SHADER,th),b=this.compileShader(d.FRAGMENT_SHADER,nh);if(!v||!b)return!1;const x=d.createProgram();if(!x)return!1;if(d.attachShader(x,v),d.attachShader(x,b),d.linkProgram(x),d.deleteShader(v),d.deleteShader(b),!d.getProgramParameter(x,d.LINK_STATUS))return console.error("WebGL Program Link Error:",d.getProgramInfoLog(x)),!1;this.program=x;const A=new Float32Array([-1,-1,3,-1,-1,3]);this.vao=d.createVertexArray(),d.bindVertexArray(this.vao),this.vbo=d.createBuffer(),d.bindBuffer(d.ARRAY_BUFFER,this.vbo),d.bufferData(d.ARRAY_BUFFER,A,d.STATIC_DRAW);const N=d.getAttribLocation(x,"a_position");return d.enableVertexAttribArray(N),d.vertexAttribPointer(N,2,d.FLOAT,!1,0,0),["u_resolution","u_time","u_phi_val","u_cam_rot","u_zoom","u_fractal_type","u_hybrid_type","u_tertiary_type","u_iterations","u_glow_intensity","u_morph_speed","u_hybrid_blend","u_tertiary_blend","u_compose_op","u_smooth_k","u_warp_strength","u_octave_layers","u_box_fold","u_sphere_fold","u_interior_cut","u_primary_color","u_secondary_color","u_accent_color","u_cam_mode","u_cam_pos","u_slice_plane","u_slice_axis","u_render_style","u_headlamp_power","u_volumetric_fog","u_palette_seed","u_palette_rotation"].forEach(F=>{this.uniformLocs[F]=d.getUniformLocation(x,F)}),!0}compileShader(s,d){if(!this.gl)return null;const u=this.gl,v=u.createShader(s);if(!v)return null;const b=u.getExtension("KHR_parallel_shader_compile");if(u.shaderSource(v,d),u.compileShader(v),b){const x=performance.now(),A=15e3;for(;!u.getShaderParameter(v,u.COMPILE_STATUS);){const N=b.COMPLETION_STATUS_KHR;if(u.getShaderParameter(v,N))break;if(performance.now()-x>A)return console.error("[WebGL2] Shader compilation timeout after 15s"),console.error("Shader info:",u.getShaderInfoLog(v)),u.deleteShader(v),null}}return u.getShaderParameter(v,u.COMPILE_STATUS)?(console.info("[WebGL2] Shader compiled successfully ("+(s===u.VERTEX_SHADER?"vertex":"fragment")+")"),v):(console.error("Shader compilation error:",u.getShaderInfoLog(v)),u.deleteShader(v),null)}render(s,d){const u=this.gl;if(!u||!this.program||!this.vao)return;u.viewport(0,0,this.canvas.width,this.canvas.height),u.useProgram(this.program),u.bindVertexArray(this.vao);const v=this.resolvePalette(d),b=this.computeIndices(d),x=new Float32Array(48);this.packUniforms(x,s,d,v,b);const A=(F,E)=>{const L=this.uniformLocs[F];L&&u.uniform1f(L,E)},N=(F,E,L)=>{const U=this.uniformLocs[F];U&&u.uniform2f(U,E,L)},g=(F,E,L,U)=>{const Y=this.uniformLocs[F];Y&&u.uniform3f(Y,E,L,U)};N("u_resolution",x[0],x[1]),A("u_time",x[2]),A("u_phi_val",x[3]),N("u_cam_rot",x[4],x[5]),A("u_zoom",x[6]),A("u_fractal_type",x[7]),A("u_iterations",x[8]),A("u_glow_intensity",x[9]),A("u_morph_speed",x[10]),A("u_hybrid_type",x[11]),A("u_hybrid_blend",x[12]),A("u_box_fold",x[13]),A("u_sphere_fold",x[14]),A("u_interior_cut",x[15]),g("u_primary_color",x[16],x[17],x[18]),A("u_tertiary_type",x[19]),g("u_secondary_color",x[20],x[21],x[22]),A("u_tertiary_blend",x[23]),g("u_accent_color",x[24],x[25],x[26]),A("u_compose_op",x[27]),A("u_smooth_k",x[28]),A("u_warp_strength",x[29]),A("u_octave_layers",x[30]),A("u_cam_mode",x[31]),g("u_cam_pos",x[32],x[33],x[34]),A("u_slice_plane",x[35]),A("u_headlamp_power",x[36]),A("u_volumetric_fog",x[37]),A("u_slice_axis",x[38]),A("u_render_style",x[39]),A("u_palette_seed",x[43]),A("u_palette_rotation",x[44]),u.drawArrays(u.TRIANGLES,0,3)}destroy(){if(this.gl){this.vao&&(this.gl.deleteVertexArray(this.vao),this.vao=null),this.vbo&&(this.gl.deleteBuffer(this.vbo),this.vbo=null),this.program&&(this.gl.deleteProgram(this.program),this.program=null);const s=this.gl.getExtension("WEBGL_lose_context");s&&s.loseContext(),this.gl=null}}}function lh(p,s){const{forcedBackend:d,isEmbeddedBrowser:u,isMobileDevice:v,paramsRef:b,onTelemetryUpdate:x,onEngineReady:A,onNextSpecimen:N,onPrevSpecimen:g,onInteraction:F,screenshotRequested:E,onScreenshotCaptured:L}=s,U=k.useRef(null),[Y,J]=k.useState(()=>d==="webgl2"?"webgl2":d==="webgpu"?u?"webgl2":"webgpu":"webgl2"),[W,B]=k.useState(!0),[ce,_]=k.useState(!1),[P,me]=k.useState("Initializing..."),[Ne,te]=k.useState(""),[Me,Ee]=k.useState(0),[qe,Ye]=k.useState(0),[Be,et]=k.useState(0),[tt,K]=k.useState(0),[D,q]=k.useState([0,0]),T=k.useRef(null),V=k.useRef(null),ee=k.useRef("Initializing..."),m=k.useRef(x);m.current=x;const R=k.useRef(L);R.current=L;const G=k.useRef(N);G.current=N;const X=k.useRef(g);X.current=g;const ne=k.useRef(F);ne.current=F;const le=k.useRef([]),pe=k.useRef(0),Qe=k.useRef(0),_e=k.useRef(null),la=k.useRef(0),ra=k.useRef(!1),Pe=k.useRef(new Set),Ea=k.useRef(!1),At=k.useRef(!0),Jt=k.useRef(!1),H=k.useRef(!1),ue=k.useRef(!1),$=k.useRef({x:0,y:0}),Re=k.useRef({x:0,y:0}),ct=k.useRef(0),cn=k.useRef(0),Rn=.92,qa=1e-4;k.useEffect(()=>{H.current=E},[E]),k.useEffect(()=>{if(d==="webgl2")J("webgl2");else if(d==="webgpu"){if(u){console.warn("[useRenderEngine] WebGPU blocked in embedded browser — using WebGL2"),ra.current=!0,J("webgl2");return}ra.current=!1,J("webgpu")}else d==="auto"&&J("webgl2")},[d]);const We=k.useCallback(()=>{const ve=U.current,Xe=p.current;if(!ve||!Xe)return;const Le=u||v?1.5:2,rt=Math.min(window.devicePixelRatio||1,Le),ut=Xe.clientWidth||window.innerWidth||800,Ce=Xe.clientHeight||window.innerHeight||600,Wt=Math.max(Math.floor(ut*rt),320),$t=Math.max(Math.floor(Ce*rt),240);if(ve.width!==Wt||ve.height!==$t){const Tt=ve.width,Ve=ve.height;ve.width=Wt,ve.height=$t,console.info(`[Resize] Canvas buffer: ${Tt}x${Ve} → ${Wt}x${$t} (container: ${ut}x${Ce}, DPR: ${rt.toFixed(2)})`)}},[u,v]);return k.useEffect(()=>{const ve=U.current;if(!ve)return;We();let Xe=!1;const Le=setTimeout(()=>{Xe||(console.warn("[useRenderEngine] Force-hiding loading overlay after 12s"),B(!1))},12e3),rt=setTimeout(()=>{!Jt.current&&!Xe&&console.error("[useRenderEngine] Engine setup timed out after 8s — GPU unavailable")},8e3);async function ut(){if(!ve)return;if(console.info("[useRenderEngine] Setup starting, activeEngineType=",Y),B(!0),Jt.current=!1,_(!1),T.current&&(T.current.destroy(),T.current=null),V.current&&(V.current.destroy(),V.current=null),Y==="webgpu"){console.info("[useRenderEngine] Attempting WebGPU init...");const It=new ec(ve);if(await It.init()&&!Xe){T.current=It,Jt.current=!0,_(!0),ee.current="WebGPU (WGSL)",me("WebGPU (WGSL)"),te(It.adapterInfo),B(!1),console.info(`[DIAG] Engine ready: WebGPU | ${It.adapterInfo} | ${ve.width}x${ve.height} | fractal=${b.current.type} | palette=${b.current.paletteId} | renderStyle=${b.current.renderStyle} | paletteSeed=${b.current.paletteSeed??0}`),A==null||A();return}else{ra.current=!0,Xe?B(!1):J("webgl2");return}}console.info("[useRenderEngine] Attempting WebGL2 init...");const Ze=new ih(ve);Ze.init()&&!Xe?(V.current=Ze,Jt.current=!0,_(!0),ee.current="WebGL2 (GLSL)",me("WebGL2 (GLSL)"),te(Ze.rendererInfo),B(!1),console.info(`[DIAG] Engine ready: WebGL2 | ${Ze.rendererInfo} | ${ve.width}x${ve.height} | fractal=${b.current.type} | palette=${b.current.paletteId} | renderStyle=${b.current.renderStyle} | paletteSeed=${b.current.paletteSeed??0}`),A==null||A()):(B(!1),A==null||A())}ut().catch(Ze=>{console.error("[useRenderEngine] Engine setup crashed:",Ze),B(!1),A==null||A()});const Ce=setTimeout(()=>{Xe||(We(),requestAnimationFrame(()=>{Xe||We()}))},100),Wt=Ze=>{Ze.preventDefault(),Ea.current=!0},$t=()=>{Ea.current=!1,ut()};ve.addEventListener("webglcontextlost",Wt,!1),ve.addEventListener("webglcontextrestored",$t,!1);const Tt=p.current;let Ve=null;return Tt&&(Ve=new ResizeObserver(()=>{Xe||We()}),Ve.observe(Tt)),()=>{var Ze,ke;Xe=!0,clearTimeout(rt),clearTimeout(Le),clearTimeout(Ce),ve.removeEventListener("webglcontextlost",Wt),ve.removeEventListener("webglcontextrestored",$t),Ve&&Ve.disconnect(),(Ze=T.current)==null||Ze.destroy(),(ke=V.current)==null||ke.destroy()}},[Y,We]),k.useEffect(()=>{let ve=!0,Xe=performance.now();const Le=()=>{At.current=!document.hidden,At.current&&(Xe=performance.now())};document.addEventListener("visibilitychange",Le);const rt=ut=>{var Ve,Ze;if(!ve)return;if(Ea.current){_e.current=requestAnimationFrame(rt);return}if(!At.current){_e.current=requestAnimationFrame(rt);return}if(!Jt.current){setTimeout(()=>{ve&&(_e.current=requestAnimationFrame(rt))},1e3);return}const Ce=b.current,Wt=ut-Xe,$t=Ce.targetFps||60,Tt=$t>=240?0:1e3/$t;if(Tt<=0||Wt>=Tt-.75){const ke=Math.min(Wt,100);Xe=ut,la.current+=ke/1e3;const It=la.current;if(Ce.cameraMode==="flyThrough"){const ft=Ce.rotX,ta=Ce.rotY,Bt=Math.cos(ft),fa=Math.sin(ft),oa=Math.cos(ta),Cn=Math.sin(ta),Mt=[fa*oa,Cn,-Bt*oa],ma=[Bt,0,fa],fn=[0,1,0];let ot=1.4*(ke/1e3);(Pe.current.has("ShiftLeft")||Pe.current.has("ShiftRight"))&&(ot*=2.8);let Ge=0,Rt=0,ha=0;(Pe.current.has("KeyW")||Pe.current.has("ArrowUp"))&&(Ge+=Mt[0]*ot,Rt+=Mt[1]*ot,ha+=Mt[2]*ot),(Pe.current.has("KeyS")||Pe.current.has("ArrowDown"))&&(Ge-=Mt[0]*ot,Rt-=Mt[1]*ot,ha-=Mt[2]*ot),(Pe.current.has("KeyA")||Pe.current.has("ArrowLeft"))&&(Ge-=ma[0]*ot,ha-=ma[2]*ot),(Pe.current.has("KeyD")||Pe.current.has("ArrowRight"))&&(Ge+=ma[0]*ot,ha+=ma[2]*ot),(Pe.current.has("KeyE")||Pe.current.has("Space"))&&(Rt+=fn[1]*ot),(Pe.current.has("KeyQ")||Pe.current.has("KeyC"))&&(Rt-=fn[1]*ot),(Ge!==0||Rt!==0||ha!==0)&&(b.current={...Ce,camPosX:(Ce.camPosX??0)+Ge,camPosY:(Ce.camPosY??0)+Rt,camPosZ:(Ce.camPosZ??0)+ha})}const hl=Ce.autoRotate?It*Ce.autoRotateSpeed*.12:0,Cr=Ce.autoRotate?Math.sin(It*.18)*.06:0;let un=0,pn=0;if(!ue.current&&(Math.abs(Re.current.x)>qa||Math.abs(Re.current.y)>qa)){const ft=Ce.zoom,ta=.0045*Math.max(.12,Math.min(1,ft/2.8)),Bt=ke;un=Re.current.x*Bt*ta*.5,pn=Re.current.y*Bt*ta*.5,Re.current.x*=Rn,Re.current.y*=Rn,Math.abs(Re.current.x)<qa&&(Re.current.x=0),Math.abs(Re.current.y)<qa&&(Re.current.y=0)}const dn={...Ce,rotX:Ce.rotX+hl+un,rotY:Math.max(-1.52,Math.min(1.52,Ce.rotY+Cr+pn))},ze=U.current;if(ze&&ze.width>0&&ze.height>0&&(T.current?T.current.render(It,dn):V.current&&V.current.render(It,dn)),H.current&&ze)try{const ft=ze.toDataURL("image/png");(Ve=R.current)==null||Ve.call(R,ft)}catch(ft){console.error("Screenshot capture failed",ft)}const ea=le.current;if(ea.push(ke),ea.length>72&&ea.shift(),ut-pe.current>250){pe.current=ut;const ft=ea.reduce((Ge,Rt)=>Ge+Rt,0)/ea.length,ta=ke>0?Math.round(1e3/ke):0,Bt=ft>0?Math.round(1e3/ft):0,fa=[...ea].sort((Ge,Rt)=>Rt-Ge),oa=Math.floor(fa.length*.05),Cn=fa[oa]||ke,Mt=Cn>0?Math.round(1e3/Cn):0,ma=T.current?T.current.adapterInfo:V.current?V.current.rendererInfo:"GPU Engine",fn=Y==="webgpu"?"WebGPU (WGSL)":"WebGL2 (GLSL)",ot={fps:ta,avgFps:Bt,frameTimeMs:parseFloat(ke.toFixed(2)),onePercentLow:Mt,backend:fn,adapterName:ma,resolution:[(ze==null?void 0:ze.width)||0,(ze==null?void 0:ze.height)||0],drsScale:1,targetFps:Ce.targetFps,interiorDistance:0};if((Ze=m.current)==null||Ze.call(m,ot),Ee(ta),Ye(Bt),et(parseFloat(ke.toFixed(2))),K(Mt),q([(ze==null?void 0:ze.width)||0,(ze==null?void 0:ze.height)||0]),Qe.current||(Qe.current=ut),ut-Qe.current>3e4){Qe.current=ut;const Ge=b.current;console.info(`[DIAG] Health: fps=${ta} avg=${Bt} 1%=${Mt} | fractal=${Ge.type} hybrid=${Ge.hybridType} | style=${Ge.renderStyle} cam=${Ge.cameraMode} | palette=${Ge.paletteId} seed=${Ge.paletteSeed??0} rot=${Ge.paletteRotation} | audio=${Ge.enableAudio} tuning=${Ge.audioTuning} | res=${ze==null?void 0:ze.width}x${ze==null?void 0:ze.height}`)}}}_e.current=requestAnimationFrame(rt)};return _e.current=requestAnimationFrame(rt),()=>{ve=!1,document.removeEventListener("visibilitychange",Le),_e.current&&cancelAnimationFrame(_e.current)}},[Y]),k.useEffect(()=>{const ve=Le=>{var rt,ut,Ce;((rt=Le.target)==null?void 0:rt.tagName)!=="INPUT"&&(Le.repeat||(Pe.current.add(Le.code),b.current.cameraMode!=="flyThrough"&&(Le.key===" "||Le.key==="ArrowRight"||Le.key==="ArrowDown"||Le.key==="PageDown"?(Le.preventDefault(),(ut=G.current)==null||ut.call(G)):(Le.key==="ArrowLeft"||Le.key==="ArrowUp"||Le.key==="PageUp")&&(Le.preventDefault(),(Ce=X.current)==null||Ce.call(X)))))},Xe=Le=>{Pe.current.delete(Le.code)};return window.addEventListener("keydown",ve),window.addEventListener("keyup",Xe),()=>{window.removeEventListener("keydown",ve),window.removeEventListener("keyup",Xe)}},[]),{activeEngineType:Y,isCompiling:W,isEngineReady:ce,backendLabel:P,adapterInfo:Ne,fps:Me,avgFps:qe,frameTimeMs:Be,onePercentLow:tt,resolution:D,canvasRef:U,keysPressedRef:Pe,isDraggingRef:ue,velocityRef:Re,lastMousePosRef:$,lastInteractionReportTimeRef:cn,lastMoveTimeRef:ct,params:b.current}}const rh=({params:p,onParamsChange:s,onTelemetryUpdate:d,screenshotRequested:u,onScreenshotCaptured:v,forcedBackend:b="auto",onInteraction:x,onNextSpecimen:A,onPrevSpecimen:N,onEngineReady:g,scrollMode:F="feed"})=>{const E=k.useRef(null),L=typeof window<"u"&&(window!==window.top||/\bqoder\b/i.test(navigator.userAgent)||/\belectron\b/i.test(navigator.userAgent)),U=typeof window<"u"&&(/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)||navigator.maxTouchPoints>1&&window.innerWidth<1024),Y=k.useRef(p);Y.current=p;const J=k.useRef(null);k.useRef(0);const W=lh(E,{forcedBackend:b,isEmbeddedBrowser:L,isMobileDevice:U,paramsRef:Y,onTelemetryUpdate:d,onEngineReady:g,onNextSpecimen:A,onPrevSpecimen:N,onInteraction:x,screenshotRequested:u,onScreenshotCaptured:v}),{canvasRef:B,isDraggingRef:ce,velocityRef:_,lastMousePosRef:P,lastInteractionReportTimeRef:me,lastMoveTimeRef:Ne,activeEngineType:te,isCompiling:Me}=W,Ee=K=>{ce.current=!0,P.current={x:K.clientX,y:K.clientY},_.current={x:0,y:0},K.target.setPointerCapture(K.pointerId)},qe=K=>{if(!ce.current)return;const D=K.clientX-P.current.x,q=K.clientY-P.current.y,T=performance.now(),V=Math.max(1,T-Ne.current);Ne.current=T,P.current={x:K.clientX,y:K.clientY};const ee=Math.hypot(D,q);T-me.current>300&&(me.current=T,x==null||x(0,ee));const m=Y.current.zoom,R=.0045*Math.max(.12,Math.min(1,m/2.8));_.current={x:D/V,y:q/V},s(G=>({...G,rotX:G.rotX+D*R,rotY:Math.max(-1.52,Math.min(1.52,G.rotY+q*R))})),nd.recordInteraction("rotate",Math.hypot(D,q)/V)},Ye=K=>{ce.current=!1;try{K.target.releasePointerCapture(K.pointerId)}catch{}},Be=K=>{K.preventDefault();const D=Math.exp(Math.sign(K.deltaY)*Math.min(Math.abs(K.deltaY)*.0018,.28));x==null||x(Math.abs(K.deltaY)*.02,0),s(q=>({...q,zoom:Math.max(.02,Math.min(64,q.zoom*D))})),nd.recordInteraction("zoom",Math.log(D)*10)},et=K=>{if(K.preventDefault(),K.touches.length===2){const D=K.touches[0],q=K.touches[1],T=Math.hypot(D.clientX-q.clientX,D.clientY-q.clientY);if(J.current!==null&&J.current>5){const V=J.current/Math.max(T,1),ee=Math.pow(V,.95);x==null||x(Math.abs(J.current-T)*.04,0),s(m=>({...m,zoom:Math.max(.02,Math.min(64,m.zoom*ee))}))}J.current=T}},tt=K=>{K.preventDefault(),J.current=null};return l.jsxs("div",{ref:E,id:"fractal-canvas-container",className:"absolute inset-0 w-full h-full overflow-hidden bg-black select-none touch-none cursor-grab active:cursor-grabbing",children:[Me&&l.jsx("div",{id:"gpu-pipeline-loading-overlay",className:"absolute inset-0 z-10 flex flex-col items-center justify-center bg-neutral-950/60 backdrop-blur-xs pointer-events-none transition-opacity duration-300",children:l.jsxs("div",{className:"flex items-center gap-2 px-4 py-2 rounded-full bg-neutral-900/90 border border-amber-500/30 text-amber-300 text-xs font-mono shadow-2xl animate-pulse",children:[l.jsx("div",{className:"w-2 h-2 rounded-full bg-amber-400 animate-ping"}),l.jsxs("span",{children:["Initializing GPU (",te==="webgpu"?"WebGPU WGSL":"WebGL2 GLSL",")..."]})]})}),l.jsx("canvas",{ref:B,id:"fractal-canvas",className:"w-full h-full block touch-none",onPointerDown:Ee,onPointerMove:qe,onPointerUp:Ye,onPointerCancel:Ye,onWheel:Be,onTouchStart:K=>K.preventDefault(),onTouchMove:et,onTouchEnd:tt},te)]})};/**
