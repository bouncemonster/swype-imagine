 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var nf;function Qm(){return nf||(nf=1,(function(u){function s(A,L){var T=A.length;A.push(L);e:for(;0<T;){var Z=T-1>>>1,J=A[Z];if(0<d(J,L))A[Z]=L,A[T]=J,T=Z;else break e}}function f(A){return A.length===0?null:A[0]}function c(A){if(A.length===0)return null;var L=A[0],T=A.pop();if(T!==L){A[0]=T;e:for(var Z=0,J=A.length,h=J>>>1;Z<h;){var M=2*(Z+1)-1,G=A[M],P=M+1,ee=A[P];if(0>d(G,T))P<J&&0>d(ee,G)?(A[Z]=ee,A[P]=T,Z=P):(A[Z]=G,A[M]=T,Z=M);else if(P<J&&0>d(ee,T))A[Z]=ee,A[P]=T,Z=P;else break e}}return L}function d(A,L){var T=A.sortIndex-L.sortIndex;return T!==0?T:A.id-L.id}if(u.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var m=performance;u.unstable_now=function(){return m.now()}}else{var z=Date,b=z.now();u.unstable_now=function(){return z.now()-b}}var g=[],y=[],H=1,F=null,B=3,q=!1,Y=!1,K=!1,W=!1,U=typeof setTimeout=="function"?setTimeout:null,oe=typeof clearTimeout=="function"?clearTimeout:null,S=typeof setImmediate<"u"?setImmediate:null;function X(A){for(var L=f(y);L!==null;){if(L.callback===null)c(y);else if(L.startTime<=A)c(y),L.sortIndex=L.expirationTime,s(g,L);else break;L=f(y)}}function ge(A){if(K=!1,X(A),!Y)if(f(g)!==null)Y=!0,Ae||(Ae=!0,Ze());else{var L=f(y);L!==null&&fe(ge,L.startTime-A)}}var Ae=!1,ae=-1,Fe=5,He=-1;function Ge(){return W?!0:!(u.unstable_now()-He<Fe)}function $e(){if(W=!1,Ae){var A=u.unstable_now();He=A;var L=!0;try{e:{Y=!1,K&&(K=!1,oe(ae),ae=-1),q=!0;var T=B;try{t:{for(X(A),F=f(g);F!==null&&!(F.expirationTime>A&&Ge());){var Z=F.callback;if(typeof Z=="function"){F.callback=null,B=F.priorityLevel;var J=Z(F.expirationTime<=A);if(A=u.unstable_now(),typeof J=="function"){F.callback=J,X(A),L=!0;break t}F===f(g)&&c(g),X(A)}else c(g);F=f(g)}if(F!==null)L=!0;else{var h=f(y);h!==null&&fe(ge,h.startTime-A),L=!1}}break e}finally{F=null,B=T,q=!1}L=void 0}}finally{L?Ze():Ae=!1}}}var Ze;if(typeof S=="function")Ze=function(){S($e)};else if(typeof MessageChannel<"u"){var pe=new MessageChannel,Ue=pe.port2;pe.port1.onmessage=$e,Ze=function(){Ue.postMessage(null)}}else Ze=function(){U($e,0)};function fe(A,L){ae=U(function(){A(u.unstable_now())},L)}u.unstable_IdlePriority=5,u.unstable_ImmediatePriority=1,u.unstable_LowPriority=4,u.unstable_NormalPriority=3,u.unstable_Profiling=null,u.unstable_UserBlockingPriority=2,u.unstable_cancelCallback=function(A){A.callback=null},u.unstable_forceFrameRate=function(A){0>A||125<A?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Fe=0<A?Math.floor(1e3/A):5},u.unstable_getCurrentPriorityLevel=function(){return B},u.unstable_next=function(A){switch(B){case 1:case 2:case 3:var L=3;break;default:L=B}var T=B;B=L;try{return A()}finally{B=T}},u.unstable_requestPaint=function(){W=!0},u.unstable_runWithPriority=function(A,L){switch(A){case 1:case 2:case 3:case 4:case 5:break;default:A=3}var T=B;B=A;try{return L()}finally{B=T}},u.unstable_scheduleCallback=function(A,L,T){var Z=u.unstable_now();switch(typeof T=="object"&&T!==null?(T=T.delay,T=typeof T=="number"&&0<T?Z+T:Z):T=Z,A){case 1:var J=-1;break;case 2:J=250;break;case 5:J=1073741823;break;case 4:J=1e4;break;default:J=5e3}return J=T+J,A={id:H++,callback:L,priorityLevel:A,startTime:T,expirationTime:J,sortIndex:-1},T>Z?(A.sortIndex=T,s(y,A),f(g)===null&&A===f(y)&&(K?(oe(ae),ae=-1):K=!0,fe(ge,T-Z))):(A.sortIndex=J,s(g,A),Y||q||(Y=!0,Ae||(Ae=!0,Ze()))),A},u.unstable_shouldYield=Ge,u.unstable_wrapCallback=function(A){var L=B;return function(){var T=B;B=L;try{return A.apply(this,arguments)}finally{B=T}}}})(ec)),ec}var lf;function Jm(){return lf||(lf=1,$s.exports=Qm()),$s.exports}var tc={exports:{}},se={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var rf;function Wm(){if(rf)return se;rf=1;var u=Symbol.for("react.transitional.element"),s=Symbol.for("react.portal"),f=Symbol.for("react.fragment"),c=Symbol.for("react.strict_mode"),d=Symbol.for("react.profiler"),m=Symbol.for("react.consumer"),z=Symbol.for("react.context"),b=Symbol.for("react.forward_ref"),g=Symbol.for("react.suspense"),y=Symbol.for("react.memo"),H=Symbol.for("react.lazy"),F=Symbol.for("react.activity"),B=Symbol.iterator;function q(h){return h===null||typeof h!="object"?null:(h=B&&h[B]||h["@@iterator"],typeof h=="function"?h:null)}var Y={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},K=Object.assign,W={};function U(h,M,G){this.props=h,this.context=M,this.refs=W,this.updater=G||Y}U.prototype.isReactComponent={},U.prototype.setState=function(h,M){if(typeof h!="object"&&typeof h!="function"&&h!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,h,M,"setState")},U.prototype.forceUpdate=function(h){this.updater.enqueueForceUpdate(this,h,"forceUpdate")};function oe(){}oe.prototype=U.prototype;function S(h,M,G){this.props=h,this.context=M,this.refs=W,this.updater=G||Y}var X=S.prototype=new oe;X.constructor=S,K(X,U.prototype),X.isPureReactComponent=!0;var ge=Array.isArray;function Ae(){}var ae={H:null,A:null,T:null,S:null},Fe=Object.prototype.hasOwnProperty;function He(h,M,G){var P=G.ref;return{$$typeof:u,type:h,key:M,ref:P!==void 0?P:null,props:G}}function Ge(h,M){return He(h.type,M,h.props)}function $e(h){return typeof h=="object"&&h!==null&&h.$$typeof===u}function Ze(h){var M={"=":"=0",":":"=2"};return"$"+h.replace(/[=:]/g,function(G){return M[G]})}var pe=/\/+/g;function Ue(h,M){return typeof h=="object"&&h!==null&&h.key!=null?Ze(""+h.key):M.toString(36)}function fe(h){switch(h.status){case"fulfilled":return h.value;case"rejected":throw h.reason;default:switch(typeof h.status=="string"?h.then(Ae,Ae):(h.status="pending",h.then(function(M){h.status==="pending"&&(h.status="fulfilled",h.value=M)},function(M){h.status==="pending"&&(h.status="rejected",h.reason=M)})),h.status){case"fulfilled":return h.value;case"rejected":throw h.reason}}throw h}function A(h,M,G,P,ee){var re=typeof h;(re==="undefined"||re==="boolean")&&(h=null);var me=!1;if(h===null)me=!0;else switch(re){case"bigint":case"string":case"number":me=!0;break;case"object":switch(h.$$typeof){case u:case s:me=!0;break;case H:return me=h._init,A(me(h._payload),M,G,P,ee)}}if(me)return ee=ee(h),me=P===""?"."+Ue(h,0):P,ge(ee)?(G="",me!=null&&(G=me.replace(pe,"$&/")+"/"),A(ee,M,G,"",function(et){return et})):ee!=null&&($e(ee)&&(ee=Ge(ee,G+(ee.key==null||h&&h.key===ee.key?"":(""+ee.key).replace(pe,"$&/")+"/")+me)),M.push(ee)),1;me=0;var Ye=P===""?".":P+":";if(ge(h))for(var he=0;he<h.length;he++)P=h[he],re=Ye+Ue(P,he),me+=A(P,M,G,re,ee);else if(he=q(h),typeof he=="function")for(h=he.call(h),he=0;!(P=h.next()).done;)P=P.value,re=Ye+Ue(P,he++),me+=A(P,M,G,re,ee);else if(re==="object"){if(typeof h.then=="function")return A(fe(h),M,G,P,ee);throw M=String(h),Error("Objects are not valid as a React child (found: "+(M==="[object Object]"?"object with keys {"+Object.keys(h).join(", ")+"}":M)+"). If you meant to render a collection of children, use an array instead.")}return me}function L(h,M,G){if(h==null)return h;var P=[],ee=0;return A(h,P,"","",function(re){return M.call(G,re,ee++)}),P}function T(h){if(h._status===-1){var M=h._result;M=M(),M.then(function(G){(h._status===0||h._status===-1)&&(h._status=1,h._result=G)},function(G){(h._status===0||h._status===-1)&&(h._status=2,h._result=G)}),h._status===-1&&(h._status=0,h._result=M)}if(h._status===1)return h._result.default;throw h._result}var Z=typeof reportError=="function"?reportError:function(h){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var M=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof h=="object"&&h!==null&&typeof h.message=="string"?String(h.message):String(h),error:h});if(!window.dispatchEvent(M))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",h);return}console.error(h)},J={map:L,forEach:function(h,M,G){L(h,function(){M.apply(this,arguments)},G)},count:function(h){var M=0;return L(h,function(){M++}),M},toArray:function(h){return L(h,function(M){return M})||[]},only:function(h){if(!$e(h))throw Error("React.Children.only expected to receive a single React element child.");return h}};return se.Activity=F,se.Children=J,se.Component=U,se.Fragment=f,se.Profiler=d,se.PureComponent=S,se.StrictMode=c,se.Suspense=g,se.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=ae,se.__COMPILER_RUNTIME={__proto__:null,c:function(h){return ae.H.useMemoCache(h)}},se.cache=function(h){return function(){return h.apply(null,arguments)}},se.cacheSignal=function(){return null},se.cloneElement=function(h,M,G){if(h==null)throw Error("The argument must be a React element, but you passed "+h+".");var P=K({},h.props),ee=h.key;if(M!=null)for(re in M.key!==void 0&&(ee=""+M.key),M)!Fe.call(M,re)||re==="key"||re==="__self"||re==="__source"||re==="ref"&&M.ref===void 0||(P[re]=M[re]);var re=arguments.length-2;if(re===1)P.children=G;else if(1<re){for(var me=Array(re),Ye=0;Ye<re;Ye++)me[Ye]=arguments[Ye+2];P.children=me}return He(h.type,ee,P)},se.createContext=function(h){return h={$$typeof:z,_currentValue:h,_currentValue2:h,_threadCount:0,Provider:null,Consumer:null},h.Provider=h,h.Consumer={$$typeof:m,_context:h},h},se.createElement=function(h,M,G){var P,ee={},re=null;if(M!=null)for(P in M.key!==void 0&&(re=""+M.key),M)Fe.call(M,P)&&P!=="key"&&P!=="__self"&&P!=="__source"&&(ee[P]=M[P]);var me=arguments.length-2;if(me===1)ee.children=G;else if(1<me){for(var Ye=Array(me),he=0;he<me;he++)Ye[he]=arguments[he+2];ee.children=Ye}if(h&&h.defaultProps)for(P in me=h.defaultProps,me)ee[P]===void 0&&(ee[P]=me[P]);return He(h,re,ee)},se.createRef=function(){return{current:null}},se.forwardRef=function(h){return{$$typeof:b,render:h}},se.isValidElement=$e,se.lazy=function(h){return{$$typeof:H,_payload:{_status:-1,_result:h},_init:T}},se.memo=function(h,M){return{$$typeof:y,type:h,compare:M===void 0?null:M}},se.startTransition=function(h){var M=ae.T,G={};ae.T=G;try{var P=h(),ee=ae.S;ee!==null&&ee(G,P),typeof P=="object"&&P!==null&&typeof P.then=="function"&&P.then(Ae,Z)}catch(re){Z(re)}finally{M!==null&&G.types!==null&&(M.types=G.types),ae.T=M}},se.unstable_useCacheRefresh=function(){return ae.H.useCacheRefresh()},se.use=function(h){return ae.H.use(h)},se.useActionState=function(h,M,G){return ae.H.useActionState(h,M,G)},se.useCallback=function(h,M){return ae.H.useCallback(h,M)},se.useContext=function(h){return ae.H.useContext(h)},se.useDebugValue=function(){},se.useDeferredValue=function(h,M){return ae.H.useDeferredValue(h,M)},se.useEffect=function(h,M){return ae.H.useEffect(h,M)},se.useEffectEvent=function(h){return ae.H.useEffectEvent(h)},se.useId=function(){return ae.H.useId()},se.useImperativeHandle=function(h,M,G){return ae.H.useImperativeHandle(h,M,G)},se.useInsertionEffect=function(h,M){return ae.H.useInsertionEffect(h,M)},se.useLayoutEffect=function(h,M){return ae.H.useLayoutEffect(h,M)},se.useMemo=function(h,M){return ae.H.useMemo(h,M)},se.useOptimistic=function(h,M){return ae.H.useOptimistic(h,M)},se.useReducer=function(h,M,G){return ae.H.useReducer(h,M,G)},se.useRef=function(h){return ae.H.useRef(h)},se.useState=function(h){return ae.H.useState(h)},se.useSyncExternalStore=function(h,M,G){return ae.H.useSyncExternalStore(h,M,G)},se.useTransition=function(){return ae.H.useTransition()},se.version="19.2.8",se}var of;function sc(){return of||(of=1,tc.exports=Wm()),tc.exports}var ac={exports:{}},Dt={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var sf;function $m(){if(sf)return Dt;sf=1;var u=sc();function s(g){var y="https://react.dev/errors/"+g;if(1<arguments.length){y+="?args[]="+encodeURIComponent(arguments[1]);for(var H=2;H<arguments.length;H++)y+="&args[]="+encodeURIComponent(arguments[H])}return"Minified React error #"+g+"; visit "+y+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function f(){}var c={d:{f,r:function(){throw Error(s(522))},D:f,C:f,L:f,m:f,X:f,S:f,M:f},p:0,findDOMNode:null},d=Symbol.for("react.portal");function m(g,y,H){var F=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:d,key:F==null?null:""+F,children:g,containerInfo:y,implementation:H}}var z=u.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function b(g,y){if(g==="font")return"";if(typeof y=="string")return y==="use-credentials"?y:""}return Dt.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=c,Dt.createPortal=function(g,y){var H=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!y||y.nodeType!==1&&y.nodeType!==9&&y.nodeType!==11)throw Error(s(299));return m(g,y,null,H)},Dt.flushSync=function(g){var y=z.T,H=c.p;try{if(z.T=null,c.p=2,g)return g()}finally{z.T=y,c.p=H,c.d.f()}},Dt.preconnect=function(g,y){typeof g=="string"&&(y?(y=y.crossOrigin,y=typeof y=="string"?y==="use-credentials"?y:"":void 0):y=null,c.d.C(g,y))},Dt.prefetchDNS=function(g){typeof g=="string"&&c.d.D(g)},Dt.preinit=function(g,y){if(typeof g=="string"&&y&&typeof y.as=="string"){var H=y.as,F=b(H,y.crossOrigin),B=typeof y.integrity=="string"?y.integrity:void 0,q=typeof y.fetchPriority=="string"?y.fetchPriority:void 0;H==="style"?c.d.S(g,typeof y.precedence=="string"?y.precedence:void 0,{crossOrigin:F,integrity:B,fetchPriority:q}):H==="script"&&c.d.X(g,{crossOrigin:F,integrity:B,fetchPriority:q,nonce:typeof y.nonce=="string"?y.nonce:void 0})}},Dt.preinitModule=function(g,y){if(typeof g=="string")if(typeof y=="object"&&y!==null){if(y.as==null||y.as==="script"){var H=b(y.as,y.crossOrigin);c.d.M(g,{crossOrigin:H,integrity:typeof y.integrity=="string"?y.integrity:void 0,nonce:typeof y.nonce=="string"?y.nonce:void 0})}}else y==null&&c.d.M(g)},Dt.preload=function(g,y){if(typeof g=="string"&&typeof y=="object"&&y!==null&&typeof y.as=="string"){var H=y.as,F=b(H,y.crossOrigin);c.d.L(g,H,{crossOrigin:F,integrity:typeof y.integrity=="string"?y.integrity:void 0,nonce:typeof y.nonce=="string"?y.nonce:void 0,type:typeof y.type=="string"?y.type:void 0,fetchPriority:typeof y.fetchPriority=="string"?y.fetchPriority:void 0,referrerPolicy:typeof y.referrerPolicy=="string"?y.referrerPolicy:void 0,imageSrcSet:typeof y.imageSrcSet=="string"?y.imageSrcSet:void 0,imageSizes:typeof y.imageSizes=="string"?y.imageSizes:void 0,media:typeof y.media=="string"?y.media:void 0})}},Dt.preloadModule=function(g,y){if(typeof g=="string")if(y){var H=b(y.as,y.crossOrigin);c.d.m(g,{as:typeof y.as=="string"&&y.as!=="script"?y.as:void 0,crossOrigin:H,integrity:typeof y.integrity=="string"?y.integrity:void 0})}else c.d.m(g)},Dt.requestFormReset=function(g){c.d.r(g)},Dt.unstable_batchedUpdates=function(g,y){return g(y)},Dt.useFormState=function(g,y,H){return z.H.useFormState(g,y,H)},Dt.useFormStatus=function(){return z.H.useHostTransitionStatus()},Dt.version="19.2.8",Dt}var cf;function eh(){if(cf)return ac.exports;cf=1;function u(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(u)}catch(s){console.error(s)}}return u(),ac.exports=$m(),ac.exports}/**
 * @license React
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ue=(u,s)=>{const f=R.forwardRef(({className:c,...d},m)=>R.createElement(Ah,{ref:m,iconNode:s,className:Df(`lucide-${Sh(mf(u))}`,`lucide-${u}`,c),...d}));return f.displayName=mf(u),f};/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Th=[["path",{d:"M12 7v14",key:"1akyts"}],["path",{d:"M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z",key:"ruj8y"}]],wn=ue("book-open",Th);/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const j2=[["path",{d:"M11.017 2.814a1 1 0 0 1 1.966 0l1.051 5.558a2 2 0 0 0 1.594 1.594l5.558 1.051a1 1 0 0 1 0 1.966l-5.558 1.051a2 2 0 0 0-1.594 1.594l-1.051 5.558a1 1 0 0 1-1.966 0l-1.051-5.558a2 2 0 0 0-1.594-1.594l-5.558-1.051a1 1 0 0 1 0-1.966l5.558-1.051a2 2 0 0 0 1.594-1.594z",key:"1s2grr"}],["path",{d:"M20 2v4",key:"1rf3ol"}],["path",{d:"M22 4h-4",key:"gwowj6"}],["circle",{cx:"4",cy:"20",r:"2",key:"6kqj1y"}]],An=ue("sparkles",j2);/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
