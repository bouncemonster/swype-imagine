(function(){const p=document.createElement("link").relList;if(p&&p.supports&&p.supports("modulepreload"))return;for(const y of document.querySelectorAll('link[rel="modulepreload"]'))c(y);new MutationObserver(y=>{for(const b of y)if(b.type==="childList")for(const w of b.addedNodes)w.tagName==="LINK"&&w.rel==="modulepreload"&&c(w)}).observe(document,{childList:!0,subtree:!0});function f(y){const b={};return y.integrity&&(b.integrity=y.integrity),y.referrerPolicy&&(b.referrerPolicy=y.referrerPolicy),y.crossOrigin==="use-credentials"?b.credentials="include":y.crossOrigin==="anonymous"?b.credentials="omit":b.credentials="same-origin",b}function c(y){if(y.ep)return;y.ep=!0;const b=f(y);fetch(y.href,b)}})();function Um(u){return u&&u.__esModule&&Object.prototype.hasOwnProperty.call(u,"default")?u.default:u}var Ls={exports:{}},al={};/**
 * @license React
 ...
 */var Pp;function Fm(){if(Pp)return al;Pp=1;var u=Symbol.for("react.transitional.element"),p=Symbol.for("react.fragment");function f(c,y,b){var w=null;if(b!==void 0&&(w=""+b),y.key!==void 0&&(w=""+y.key),"key"in y){b={};for(var q in y)q!=="key"&&(b[q]=y[q])}else b=y;return y=b.ref,{$$typeof:u,type:c,key:w,ref:y!==void 0?y:null,props:b}}return al.Fragment=p,al.jsx=f,al.jsxs=f,al}var Vp;function Bm(){return Vp||(Vp=1,Ls.exports=Fm()),Ls.exports}var l=Bm(),Us={exports:{}},nl={},Fs={exports:{}},Bs={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Zp;function Gm(){return Zp||(Zp=1,(function(u){function p(S,O){var Z=S.length;S.push(O);e:for(;0<Z;){var W=Z-1>>>1,re=S[W];if(0<y(re,O))S[W]=O,S[Z]=re,Z=W;else break e}}function f(S){return S.length===0?null:S[0]}function c(S){if(S.length===0)return null;var O=S[0],Z=S.pop();if(Z!==O){S[0]=Z;e:for(var W=0,re=S.length,h=re>>>1;W<h;){var A=2*(W+1)-1,X=S[A],Y=A+1,K=S[Y];if(0>y(X,Z))Y<re&&0>y(K,X)?(S[W]=K,S[Y]=Z,W=Y):(S[W]=X,S[A]=Z,W=A);else if(Y<re&&0>y(K,Z))S[W]=K,S[Y]=Z,W=Y;else break e}}return O}function y(S,O){var Z=S.sortIndex-O.sortIndex;return Z!==0?Z:S.id-O.id}if(u.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var b=performance;u.unstable_now=function(){return b.now()}}else{var w=Date,q=w.now();u.unstable_now=function(){return w.now()-q}}var T=[],m=[],E=1,k=null,B=3,L=!1,V=!1,ee=!1,$=!1,F=typeof setTimeout=="function"?setTimeout:null,le=typeof clearTimeout=="function"?clearTimeout:null,g=typeof setImmediate<"u"?setImmediate:null;function U(S){for(var O=f(m);O!==null;){if(O.callback===null)c(m);else if(O.startTime<=S)c(m),O.sortIndex=O.expirationTime,p(T,O);else break;O=f(m)}}function be(S){if(ee=!1,U(S),!V)if(f(T)!==null)V=!0,ge||(ge=!0,Ge());else{var O=f(m);O!==null&&fe(be,O.startTime-S)}}var ge=!1,ae=-1,je=5,Se=-1;function Ze(){return $?!0:!(u.unstable_now()-Se<je)}function Te(){if($=!1,ge){var S=u.unstable_now();Se=S;var O=!0;try{e:{V=!1,ee&&(ee=!1,le(ae),ae=-1),L=!0;var Z=B;try{t:{for(U(S),k=f(T);k!==null&&!(k.expirationTime>S&&Ze());){var W=k.callback;if(typeof W=="function"){k.callback=null,B=k.priorityLevel;var re=W(k.expirationTime<=S);if(S=u.unstable_now(),typeof re=="function"){k.callback=re,U(S),O=!0;break t}k===f(T)&&c(T),U(S)}else c(T);k=f(T)}if(k!==null)O=!0;else{var h=f(m);h!==null&&fe(be,h.startTime-S),O=!1}}break e}finally{k=null,B=Z,L=!1}O=void 0}}finally{O?Ge():ge=!1}}}var Ge;if(typeof g=="function")Ge=function(){g(Te)};else if(typeof MessageChannel<"u"){var Qe=new MessageChannel,Xe=Qe.port2;Qe.port1.onmessage=Te,Ge=function(){Xe.postMessage(null)}}else Ge=function(){F(Te,0)};function fe(S,O){ae=F(function(){S(u.unstable_now())},O)}u.unstable_IdlePriority=5,u.unstable_ImmediatePriority=1,u.unstable_LowPriority=4,u.unstable_NormalPriority=3,u.unstable_Profiling=null,u.unstable_UserBlockingPriority=2,u.unstable_cancelCallback=function(S){S.callback=null},u.unstable_forceFrameRate=function(S){0>S||125<S?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):je=0<S?Math.floor(1e3/S):5},u.unstable_getCurrentPriorityLevel=function(){return B},u.unstable_next=function(S){switch(B){case 1:case 2:case 3:var O=3;break;default:O=B}var Z=B;B=O;try{return S()}finally{B=Z}},u.unstable_requestPaint=function(){$=!0},u.unstable_runWithPriority=function(S,O){switch(S){case 1:case 2:case 3:case 4:case 5:break;default:S=3}var Z=B;B=S;try{return O()}finally{B=Z}},u.unstable_scheduleCallback=function(S,O,Z){var W=u.unstable_now();switch(typeof Z=="object"&&Z!==null?(Z=Z.delay,Z=typeof Z=="number"&&0<Z?W+Z:W):Z=W,S){case 1:var re=-1;break;case 2:re=250;break;case 5:re=1073741823;break;case 4:re=1e4;break;default:re=5e3}return re=Z+re,S={id:E++,callback:O,priorityLevel:S,startTime:Z,expirationTime:re,sortIndex:-1},Z>W?(S.sortIndex=Z,p(m,S),f(T)===null&&S===f(m)&&(ee?(le(ae),ae=-1):ee=!0,fe(be,Z-W))):(S.sortIndex=re,p(T,S),V||L||(V=!0,ge||(ge=!0,Ge()))),S},u.unstable_shouldYield=Ze,u.unstable_wrapCallback=function(S){var O=B;return function(){var Z=B;B=O;try{return S.apply(this,arguments)}finally{B=Z}}}})(Bs)),Bs}var Qp;function Hm(){return Qp||(Qp=1,Fs.exports=Gm()),Fs.exports}var Gs={exports:{}},oe={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Kp;function Ym(){if(Kp)return oe;Kp=1;var u=Symbol.for("react.transitional.element"),p=Symbol.for("react.portal"),f=Symbol.for("react.fragment"),c=Symbol.for("react.strict_mode"),y=Symbol.for("react.profiler"),b=Symbol.for("react.consumer"),w=Symbol.for("react.context"),q=Symbol.for("react.forward_ref"),T=Symbol.for("react.suspense"),m=Symbol.for("react.memo"),E=Symbol.for("react.lazy"),k=Symbol.for("react.activity"),B=Symbol.iterator;function L(h){return h===null||typeof h!="object"?null:(h=B&&h[B]||h["@@iterator"],typeof h=="function"?h:null)}var V={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},ee=Object.assign,$={};function F(h,A,X){this.props=h,this.context=A,this.refs=$,this.updater=X||V}F.prototype.isReactComponent={},F.prototype.setState=function(h,A){if(typeof h!="object"&&typeof h!="function"&&h!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,h,A,"setState")},F.prototype.forceUpdate=function(h){this.updater.enqueueForceUpdate(this,h,"forceUpdate")};function le(){}le.prototype=F.prototype;function g(h,A,X){this.props=h,this.context=A,this.refs=$,this.updater=X||V}var U=g.prototype=new le;U.constructor=g,ee(U,F.prototype),U.isPureReactComponent=!0;var be=Array.isArray;function ge(){}var ae={H:null,A:null,T:null,S:null},je=Object.prototype.hasOwnProperty;function Se(h,A,X){var Y=X.ref;return{$$typeof:u,type:h,key:A,ref:Y!==void 0?Y:null,props:X}}function Ze(h,A){return Se(h.type,A,h.props)}function Te(h){return typeof h=="object"&&h!==null&&h.$$typeof===u}function Ge(h){var A={"=":"=0",":":"=2"};return"$"+h.replace(/[=:]/g,function(X){return A[X]})}var Qe=/\/+/g;function Xe(h,A){return typeof h=="object"&&h!==null&&h.key!=null?Ge(""+h.key):A.toString(36)}function fe(h){switch(h.status){case"fulfilled":return h.value;case"rejected":throw h.reason;default:switch(typeof h.status=="string"?h.then(ge,ge):(h.status="pending",h.then(function(A){h.status==="pending"&&(h.status="fulfilled",h.value=A)},function(A){h.status==="pending"&&(h.status="rejected",h.reason=A)})),h.status){case"fulfilled":return h.value;case"rejected":throw h.reason}}throw h}function S(h,A,X,Y,K){var ie=typeof h;(ie==="undefined"||ie==="boolean")&&(h=null);var de=!1;if(h===null)de=!0;else switch(ie){case"bigint":case"string":case"number":de=!0;break;case"object":switch(h.$$typeof){case u:case p:de=!0;break;case E:return de=h._init,S(de(h._payload),A,X,Y,K)}}if(de)return K=K(h),de=Y===""?"."+Xe(h,0):Y,be(K)?(X="",de!=null&&(X=de.replace(Qe,"$&/")+"/"),S(K,A,X,"",function(Pt){return Pt})):K!=null&&(Te(K)&&(K=Ze(K,X+(K.key==null||h&&h.key===K.key?"":(""+K.key).replace(Qe,"$&/")+"/")+de)),A.push(K)),1;de=0;var Fe=Y===""?".":Y+":";if(be(h))for(var Ee=0;Ee<h.length;Ee++)Y=h[Ee],ie=Fe+Xe(Y,Ee),de+=S(Y,A,X,ie,K);else if(Ee=L(h),typeof Ee=="function")for(h=Ee.call(h),Ee=0;!(Y=h.next()).done;)Y=Y.value,ie=Fe+Xe(Y,Ee++),de+=S(Y,A,X,ie,K);else if(ie==="object"){if(typeof h.then=="function")return S(fe(h),A,X,Y,K);throw A=String(h),Error("Objects are not valid as a React child (found: "+(A==="[object Object]"?"object with keys {"+Object.keys(h).join(", ")+"}":A)+"). If you meant to render a collection of children, use an array instead.")}return de}function O(h,A,X){if(h==null)return h;var Y=[],K=0;return S(h,Y,"","",function(ie){return A.call(X,ie,K++)}),Y}function Z(h){if(h._status===-1){var A=h._result;A=A(),A.then(function(X){(h._status===0||h._status===-1)&&(h._status=1,h._result=X)},function(X){(h._status===0||h._status===-1)&&(h._status=2,h._result=X)}),h._status===-1&&(h._status=0,h._result=A)}if(h._status===1)return h._result.default;throw h._result}var W=typeof reportError=="function"?reportError:function(h){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var A=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof h=="object"&&h!==null&&typeof h.message=="string"?String(h.message):String(h),error:h});if(!window.dispatchEvent(A))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",h);return}console.error(h)},re={map:O,forEach:function(h,A,X){O(h,function(){A.apply(this,arguments)},X)},count:function(h){var A=0;return O(h,function(){A++}),A},toArray:function(h){return O(h,function(A){return A})||[]},only:function(h){if(!Te(h))throw Error("React.Children.only expected to receive a single React element child.");return h}};return oe.Activity=k,oe.Children=re,oe.Component=F,oe.Fragment=f,oe.Profiler=y,oe.PureComponent=g,oe.StrictMode=c,oe.Suspense=T,oe.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=ae,oe.__COMPILER_RUNTIME={__proto__:null,c:function(h){return ae.H.useMemoCache(h)}},oe.cache=function(h){return function(){return h.apply(null,arguments)}},oe.cacheSignal=function(){return null},oe.cloneElement=function(h,A,X){if(h==null)throw Error("The argument must be a React element, but you passed "+h+".");var Y=ee({},h.props),K=h.key;if(A!=null)for(ie in A.key!==void 0&&(K=""+A.key),A)!je.call(A,ie)||ie==="key"||ie==="__self"||ie==="__source"||ie==="ref"&&A.ref===void 0||(Y[ie]=A[ie]);var ie=arguments.length-2;if(ie===1)Y.children=X;else if(1<ie){for(var de=Array(ie),Fe=0;Fe<ie;Fe++)de[Fe]=arguments[Fe+2];Y.children=de}return Se(h.type,K,Y)},oe.createContext=function(h){return h={$$typeof:w,_currentValue:h,_currentValue2:h,_threadCount:0,Provider:null,Consumer:null},h.Provider=h,h.Consumer={$$typeof:b,_context:h},h},oe.createElement=function(h,A,X){var Y,K={},ie=null;if(A!=null)for(Y in A.key!==void 0&&(ie=""+A.key),A)je.call(A,Y)&&Y!=="key"&&Y!=="__self"&&Y!=="__source"&&(K[Y]=A[Y]);var de=arguments.length-2;if(de===1)K.children=X;else if(1<de){for(var Fe=Array(de),Ee=0;Ee<de;Ee++)Fe[Ee]=arguments[Ee+2];K.children=Fe}if(h&&h.defaultProps)for(Y in de=h.defaultProps,de)K[Y]===void 0&&(K[Y]=de[Y]);return Se(h,ie,K)},oe.createRef=function(){return{current:null}},oe.forwardRef=function(h){return{$$typeof:q,render:h}},oe.isValidElement=Te,oe.lazy=function(h){return{$$typeof:E,_payload:{_status:-1,_result:h},_init:Z}},oe.memo=function(h,A){return{$$typeof:m,type:h,compare:A===void 0?null:A}},oe.startTransition=function(h){var A=ae.T,X={};ae.T=X;try{var Y=h(),K=ae.S;K!==null&&K(X,Y),typeof Y=="object"&&Y!==null&&typeof Y.then=="function"&&Y.then(ge,W)}catch(ie){W(ie)}finally{A!==null&&X.types!==null&&(A.types=X.types),ae.T=A}},oe.unstable_useCacheRefresh=function(){return ae.H.useCacheRefresh()},oe.use=function(h){return ae.H.use(h)},oe.useActionState=function(h,A,X){return ae.H.useActionState(h,A,X)},oe.useCallback=function(h,A){return ae.H.useCallback(h,A)},oe.useContext=function(h){return ae.H.useContext(h)},oe.useDebugValue=function(){},oe.useDeferredValue=function(h,A){return ae.H.useDeferredValue(h,A)},oe.useEffect=function(h,A){return ae.H.useEffect(h,A)},oe.useEffectEvent=function(h){return ae.H.useEffectEvent(h)},oe.useId=function(){return ae.H.useId()},oe.useImperativeHandle=function(h,A,X){return ae.H.useImperativeHandle(h,A,X)},oe.useInsertionEffect=function(h,A){return ae.H.useInsertionEffect(h,A)},oe.useLayoutEffect=function(h,A){return ae.H.useLayoutEffect(h,A)},oe.useMemo=function(h,A){return ae.H.useMemo(h,A)},oe.useOptimistic=function(h,A){return ae.H.useOptimistic(h,A)},oe.useReducer=function(h,A,X){return ae.H.useReducer(h,A,X)},oe.useRef=function(h){return ae.H.useRef(h)},oe.useState=function(h){return ae.H.useState(h)},oe.useSyncExternalStore=function(h,A,X){return ae.H.useSyncExternalStore(h,A,X)},oe.useTransition=function(){return ae.H.useTransition()},oe.version="19.2.8",oe}var Jp;function Zs(){return Jp||(Jp=1,Gs.exports=Ym()),Gs.exports}var Hs={exports:{}},ht={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Wp;function Xm(){if(Wp)return ht;Wp=1;var u=Zs();function p(T){var m="https://react.dev/errors/"+T;if(1<arguments.length){m+="?args[]="+encodeURIComponent(arguments[1]);for(var E=2;E<arguments.length;E++)m+="&args[]="+encodeURIComponent(arguments[E])}return"Minified React error #"+T+"; visit "+m+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function f(){}var c={d:{f,r:function(){throw Error(p(522))},D:f,C:f,L:f,m:f,X:f,S:f,M:f},p:0,findDOMNode:null},y=Symbol.for("react.portal");function b(T,m,E){var k=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:y,key:k==null?null:""+k,children:T,containerInfo:m,implementation:E}}var w=u.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function q(T,m){if(T==="font")return"";if(typeof m=="string")return m==="use-credentials"?m:""}return ht.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=c,ht.createPortal=function(T,m){var E=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!m||m.nodeType!==1&&m.nodeType!==9&&m.nodeType!==11)throw Error(p(299));return b(T,m,null,E)},ht.flushSync=function(T){var m=w.T,E=c.p;try{if(w.T=null,c.p=2,T)return T()}finally{w.T=m,c.p=E,c.d.f()}},ht.preconnect=function(T,m){typeof T=="string"&&(m?(m=m.crossOrigin,m=typeof m=="string"?m==="use-credentials"?m:"":void 0):m=null,c.d.C(T,m))},ht.prefetchDNS=function(T){typeof T=="string"&&c.d.D(T)},ht.preinit=function(T,m){if(typeof T=="string"&&m&&typeof m.as=="string"){var E=m.as,k=q(E,m.crossOrigin),B=typeof m.integrity=="string"?m.integrity:void 0,L=typeof m.fetchPriority=="string"?m.fetchPriority:void 0;E==="style"?c.d.S(T,typeof m.precedence=="string"?m.precedence:void 0,{crossOrigin:k,integrity:B,fetchPriority:L}):E==="script"&&c.d.X(T,{crossOrigin:k,integrity:B,fetchPriority:L,nonce:typeof m.nonce=="string"?m.nonce:void 0})}},ht.preinitModule=function(T,m){if(typeof T=="string")if(typeof m=="object"&&m!==null){if(m.as==null||m.as==="script"){var E=q(m.as,m.crossOrigin);c.d.M(T,{crossOrigin:E,integrity:typeof m.integrity=="string"?m.integrity:void 0,nonce:typeof m.nonce=="string"?m.nonce:void 0})}}else m==null&&c.d.M(T)},ht.preload=function(T,m){if(typeof T=="string"&&typeof m=="object"&&m!==null&&typeof m.as=="string"){var E=m.as,k=q(E,m.crossOrigin);c.d.L(T,E,{crossOrigin:k,integrity:typeof m.integrity=="string"?m.integrity:void 0,nonce:typeof m.nonce=="string"?m.nonce:void 0,type:typeof m.type=="string"?m.type:void 0,fetchPriority:typeof m.fetchPriority=="string"?m.fetchPriority:void 0,referrerPolicy:typeof m.referrerPolicy=="string"?m.referrerPolicy:void 0,imageSrcSet:typeof m.imageSrcSet=="string"?m.imageSrcSet:void 0,imageSizes:typeof m.imageSizes=="string"?m.imageSizes:void 0,media:typeof m.media=="string"?m.media:void 0})}},ht.preloadModule=function(T,m){if(typeof T=="string")if(m){var E=q(m.as,m.crossOrigin);c.d.m(T,{as:typeof m.as=="string"&&m.as!=="script"?m.as:void 0,crossOrigin:E,integrity:typeof m.integrity=="string"?m.integrity:void 0})}else c.d.m(T)},ht.requestFormReset=function(T){c.d.r(T)},ht.unstable_batchedUpdates=function(T,m){return T(m)},ht.useFormState=function(T,m,E){return w.H.useFormState(T,m,E)},ht.useFormStatus=function(){return w.H.useHostTransitionStatus()},ht.version="19.2.8",ht}var $p;function Pm(){if($p)return Hs.exports;$p=1;function u(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(u)}catch(p){console.error(p)}}return u(),Hs.exports=Xm(),Hs.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Ip;function Vm(){if(Ip)return nl;Ip=1;var u=Hm(),p=Zs(),f=Pm();function c(e){var t="https://react.dev/errors/"+e;if(1<arguments.length){t+="?args[]="+encodeURIComponent(arguments[1]);for(var a=2;a<arguments.length;a++)t+="&args[]="+encodeURIComponent(arguments[a])}return"Minified React error #"+e+"; visit "+t+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function y(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11)}function b(e){var t=e,a=e;if(e.alternate)for(;t.return;)t=t.return;else{e=t;do t=e,(t.flags&4098)!==0&&(a=t.return),e=t.return;while(e)}return t.tag===3?a:null}function w(e){if(e.tag===13){var t=e.memoizedState;if(t===null&&(e=e.alternate,e!==null&&(t=e.memoizedState)),t!==null)return t.dehydrated}return null}function q(e){if(e.tag===31){var t=e.memoizedState;if(t===null&&(e=e.alternate,e!==null&&(t=e.memoizedState)),t!==null)return t.dehydrated}return null}function T(e){if(b(e)!==e)throw Error(c(188))}function m(e){var t=e.alternate;if(!t){if(t=b(e),t===null)throw Error(c(188));return t!==e?null:e}for(var a=e,n=t;;){var i=a.return;if(i===null)break;var r=i.alternate;if(r===null){if(n=i.return,n!==null){a=n;continue}break}if(i.child===r.child){for(r=i.child;r;){if(r===a)return T(i),e;if(r===n)return T(i),t;r=r.sibling}throw Error(c(188))}if(a.return!==n.return)a=i,n=r;else{for(var o=!1,s=i.child;s;){if(s===a){o=!0,a=i,n=r;break}if(s===n){o=!0,n=i,a=r;break}s=s.sibling}if(!o){for(s=r.child;s;){if(s===a){o=!0,a=r,n=i;break}if(s===n){o=!0,n=r,a=i;break}s=s.sibling}if(!o)throw Error(c(189))}}if(a.alternate!==n)throw Error(c(190))}if(a.tag!==3)throw Error(c(188));return a.stateNode.current===a?e:t}function E(e){var t=e.tag;if(t===5||t===26||t===27||t===6)return e;for(e=e.child;e!==null;){if(t=E(e),t!==null)return t;e=e.sibling}return null}var k=Object.assign,B=Symbol.for("react.element"),L=Symbol.for("react.transitional.element"),V=Symbol.for("react.portal"),ee=Symbol.for("react.fragment"),$=Symbol.for("react.strict_mode"),F=Symbol.for("react.profiler"),le=Symbol.for("react.consumer"),g=Symbol.for("react.context"),U=Symbol.for("react.forward_ref"),be=Symbol.for("react.suspense"),ge=Symbol.for("react.suspense_list"),ae=Symbol.for("react.memo"),je=Symbol.for("react.lazy"),Se=Symbol.for("react.activity"),Ze=Symbol.for("react.memo_cache_sentinel"),Te=Symbol.iterator;function Ge(e){return e===null||typeof e!="object"?null:(e=Te&&e[Te]||e["@@iterator"],typeof e=="function"?e:null)}var Qe=Symbol.for("react.client.reference");function Xe(e){if(e==null)return null;if(typeof e=="function")return e.$$typeof===Qe?null:e.displayName||e.name||null;if(typeof e=="string")return e;switch(e){case ee:return"Fragment";case F:return"Profiler";case $:return"StrictMode";case be:return"Suspense";case ge:return"SuspenseList";case Se:return"Activity"}if(typeof e=="object")switch(e.$$typeof){case V:return"Portal";case g:return e.displayName||"Context";case le:return(e._context.displayName||"Context")+".Consumer";case U:var t=e.render;return e=e.displayName,e||(e=t.displayName||t.name||"",e=e!==""?"ForwardRef("+e+")":"ForwardRef"),e;case ae:return t=e.displayName||null,t!==null?t:Xe(e.type)||"Memo";case je:t=e._payload,e=e._init;try{return Xe(e(t))}catch{}}return null}var fe=Array.isArray,S=p.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,O=f.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,Z={pending:!1,data:null,method:null,action:null},W=[],re=-1;function h(e){return{current:e}}function A(e){0>re||(e.current=W[re],W[re]=null,re--)}function X(e,t){re++,W[re]=e.current,e.current=t}var Y=h(null),K=h(null),ie=h(null),de=h(null);function Fe(e,t){switch(X(ie,t),X(K,e),X(Y,null),t.nodeType){case 9:case 11:e=(e=t.documentElement)&&(e=e.namespaceURI)?mp(e):0;break;default:if(e=t.tagName,t=t.namespaceURI)t=mp(t),e=hp(t,e);else switch(e){case"svg":e=1;break;case"math":e=2;break;default:e=0}}A(Y),X(Y,e)}function Ee(){A(Y),A(K),A(ie)}function Pt(e){e.memoizedState!==null&&X(de,e);var t=Y.current,a=hp(t,e.type);t!==a&&(X(K,e),X(Y,a))}function Ma(e){K.current===e&&(A(Y),A(K)),de.current===e&&(A(de),$i._currentValue=Z)}var nn,ln;function Vt(e){if(nn===void 0)try{throw Error()}catch(a){var t=a.stack.trim().match(/\n( *(at )?)/);nn=t&&t[1]||"",ln=-1<a.stack.indexOf(`
...
`,eh=Im;class th{constructor(p){this.gl=null,this.program=null,this.vao=null,this.vbo=null,this.uniformLocs={},this.rendererInfo="WebGL2 Shader Pipeline",this.canvas=p}init(){console.group("[WebGL2] === INITIALIZATION START ==="),console.info("[WebGL2] Canvas element:",this.canvas),console.info("[WebGL2] Canvas size (CSS):",this.canvas.clientWidth,"x",this.canvas.clientHeight),console.info("[WebGL2] Canvas size (buffer):",this.canvas.width,"x",this.canvas.height),console.info("[WebGL2] User Agent:",navigator.userAgent),console.info("[WebGL2] Device Pixel Ratio:",window.devicePixelRatio);const p=this.canvas.getBoundingClientRect();(p.width===0||p.height===0)&&(console.warn("[WebGL2] Canvas has zero dimensions, setting fallback size..."),this.canvas.width=Math.max(1,this.canvas.clientWidth||800),this.canvas.height=Math.max(1,this.canvas.clientHeight||600)),console.info('[WebGL2] Attempt 1: getContext("webgl2") with no options...');let f=this.canvas.getContext("webgl2");if(console.info("[WebGL2] Result:",f?"SUCCESS":"FAILED"),f||(console.info("[WebGL2] Attempt 2: webgl2 with preserveDrawingBuffer..."),f=this.canvas.getContext("webgl2",{alpha:!1,antialias:!1,powerPreference:"high-performance",preserveDrawingBuffer:!0}),console.info("[WebGL2] Result:",f?"SUCCESS":"FAILED")),f||(console.info("[WebGL2] Attempt 3: webgl2 with high-performance..."),f=this.canvas.getContext("webgl2",{alpha:!1,antialias:!1,powerPreference:"high-performance"}),console.info("[WebGL2] Result:",f?"SUCCESS":"FAILED")),!f){console.warn("[WebGL2] All webgl2 attempts failed, trying webgl (WebGL1)...");const E=this.canvas.getContext("webgl")||this.canvas.getContext("experimental-webgl");return E&&(console.error("[WebGL2] WebGL1 obtained but WebGL2 is required. Check chrome://gpu"),console.error("[WebGL2] WebGL1 renderer:",E.getParameter(E.RENDERER))),console.error("[WebGL2] === INITIALIZATION FAILED ==="),console.groupEnd(),!1}this.gl=f,console.info("[WebGL2] Context acquired!"),console.info("[WebGL2] GL_VERSION:",f.getParameter(f.VERSION)),console.info("[WebGL2] GL_RENDERER:",f.getParameter(f.RENDERER)),console.info("[WebGL2] GL_VENDOR:",f.getParameter(f.VENDOR)),console.info("[WebGL2] GL_SHADING_LANGUAGE_VERSION:",f.getParameter(f.SHADING_LANGUAGE_VERSION));const c=f.getSupportedExtensions();console.info("[WebGL2] Supported extensions count:",(c==null?void 0:c.length)||0),console.info("[WebGL2] KHR_parallel_shader_compile:",c==null?void 0:c.includes("KHR_parallel_shader_compile")),console.info("[WebGL2] WEBGL_debug_renderer_info:",c==null?void 0:c.includes("WEBGL_debug_renderer_info"));try{const E=f.getExtension("WEBGL_debug_renderer_info");if(E){const k=f.getParameter(E.UNMASKED_RENDERER_WEBGL);k&&(this.rendererInfo=k)}}catch{this.rendererInfo="WebGL2 Hardware Engine"}const y=this.compileShader(f.VERTEX_SHADER,$m),b=this.compileShader(f.FRAGMENT_SHADER,eh);if(!y||!b)return!1;const w=f.createProgram();if(!w)return!1;if(f.attachShader(w,y),f.attachShader(w,b),f.linkProgram(w),f.deleteShader(y),f.deleteShader(b),!f.getProgramParameter(w,f.LINK_STATUS))return console.error("WebGL Program Link Error:",f.getProgramInfoLog(w)),!1;this.program=w;const q=new Float32Array([-1,-1,3,-1,-1,3]);this.vao=f.createVertexArray(),f.bindVertexArray(this.vao),this.vbo=f.createBuffer(),f.bindBuffer(f.ARRAY_BUFFER,this.vbo),f.bufferData(f.ARRAY_BUFFER,q,f.STATIC_DRAW);const T=f.getAttribLocation(w,"a_position");return f.enableVertexAttribArray(T),f.vertexAttribPointer(T,2,f.FLOAT,!1,0,0),["u_resolution","u_time","u_phi_val","u_cam_rot","u_zoom","u_fractal_type","u_hybrid_type","u_tertiary_type","u_iterations","u_glow_intensity","u_morph_speed","u_hybrid_blend","u_tertiary_blend","u_compose_op","u_smooth_k","u_warp_strength","u_octave_layers","u_box_fold","u_sphere_fold","u_interior_cut","u_primary_color","u_secondary_color","u_accent_color","u_cam_mode","u_cam_pos","u_slice_plane","u_slice_axis","u_render_style","u_headlamp_power","u_volumetric_fog","u_palette_seed"].forEach(E=>{this.uniformLocs[E]=f.getUniformLocation(w,E)}),!0}compileShader(p,f){if(!this.gl)return null;const c=this.gl,y=c.createShader(p);if(!y)return null;const b=c.getExtension("KHR_parallel_shader_compile");if(c.shaderSource(y,f),c.compileShader(y),b){const w=performance.now(),q=15e3;for(;!c.getShaderParameter(y,c.COMPILE_STATUS);){const T=b.COMPLETION_STATUS_KHR;if(c.getShaderParameter(y,T))break;if(performance.now()-w>q)return console.error("[WebGL2] Shader compilation timeout after 15s"),console.error("Shader info:",c.getShaderInfoLog(y)),c.deleteShader(y),null}}return c.getShaderParameter(y,c.COMPILE_STATUS)?(console.info("[WebGL2] Shader compiled successfully ("+(p===c.VERTEX_SHADER?"vertex":"fragment")+")"),y):(console.error("Shader compilation error:",c.getShaderInfoLog(y)),c.deleteShader(y),null)}render(p,f){const c=this.gl;if(!c||!this.program||!this.vao)return;c.viewport(0,0,this.canvas.width,this.canvas.height),c.useProgram(this.program),c.bindVertexArray(this.vao);const y=f.customPalette||$t.find(T=>T.id===f.paletteId)||$t[0],b=ci(f.type),w=ci(f.hybridType||f.type),q=ci(f.tertiaryType||"riemannZeta");this.uniformLocs.u_resolution&&c.uniform2f(this.uniformLocs.u_resolution,this.canvas.width,this.canvas.height),this.uniformLocs.u_time&&c.uniform1f(this.uniformLocs.u_time,p),this.uniformLocs.u_phi_val&&c.uniform1f(this.uniformLocs.u_phi_val,f.phiMultiplier),this.uniformLocs.u_cam_rot&&c.uniform2f(this.uniformLocs.u_cam_rot,f.rotX,f.rotY),this.uniformLocs.u_zoom&&c.uniform1f(this.uniformLocs.u_zoom,f.zoom),this.uniformLocs.u_fractal_type&&c.uniform1f(this.uniformLocs.u_fractal_type,b),this.uniformLocs.u_hybrid_type&&c.uniform1f(this.uniformLocs.u_hybrid_type,w),this.uniformLocs.u_tertiary_type&&c.uniform1f(this.uniformLocs.u_tertiary_type,q),this.uniformLocs.u_iterations&&c.uniform1f(this.uniformLocs.u_iterations,f.iterations),this.uniformLocs.u_glow_intensity&&c.uniform1f(this.uniformLocs.u_glow_intensity,f.glowIntensity),this.uniformLocs.u_morph_speed&&c.uniform1f(this.uniformLocs.u_morph_speed,f.morphSpeed),this.uniformLocs.u_hybrid_blend&&c.uniform1f(this.uniformLocs.u_hybrid_blend,f.hybridBlend??0),this.uniformLocs.u_tertiary_blend&&c.uniform1f(this.uniformLocs.u_tertiary_blend,f.tertiaryBlend??0),this.uniformLocs.u_compose_op&&c.uniform1f(this.uniformLocs.u_compose_op,pf(f.compositeOp)),this.uniformLocs.u_smooth_k&&c.uniform1f(this.uniformLocs.u_smooth_k,f.smoothK??.35),this.uniformLocs.u_warp_strength&&c.uniform1f(this.uniformLocs.u_warp_strength,f.warpStrength??.3),this.uniformLocs.u_octave_layers&&c.uniform1f(this.uniformLocs.u_octave_layers,f.octaveLayers??2),this.uniformLocs.u_box_fold&&c.uniform1f(this.uniformLocs.u_box_fold,f.boxFold??1.2),this.uniformLocs.u_sphere_fold&&c.uniform1f(this.uniformLocs.u_sphere_fold,f.sphereFold??.65),this.uniformLocs.u_interior_cut&&c.uniform1f(this.uniformLocs.u_interior_cut,f.interiorCut??.35),this.uniformLocs.u_primary_color&&c.uniform3f(this.uniformLocs.u_primary_color,y.primary[0],y.primary[1],y.primary[2]),this.uniformLocs.u_secondary_color&&c.uniform3f(this.uniformLocs.u_secondary_color,y.secondary[0],y.secondary[1],y.secondary[2]),this.uniformLocs.u_accent_color&&c.uniform3f(this.uniformLocs.u_accent_color,y.accent[0],y.accent[1],y.accent[2]),this.uniformLocs.u_cam_mode&&c.uniform1f(this.uniformLocs.u_cam_mode,ff(f.cameraMode)),this.uniformLocs.u_cam_pos&&c.uniform3f(this.uniformLocs.u_cam_pos,f.camPosX??0,f.camPosY??0,f.camPosZ??0),this.uniformLocs.u_slice_plane&&c.uniform1f(this.uniformLocs.u_slice_plane,f.slicePlane??0),this.uniformLocs.u_slice_axis&&c.uniform1f(this.uniformLocs.u_slice_axis,df(f.sliceAxis)),this.uniformLocs.u_render_style&&c.uniform1f(this.uniformLocs.u_render_style,mf(f.renderStyle)),this.uniformLocs.u_headlamp_power&&c.uniform1f(this.uniformLocs.u_headlamp_power,f.headlampPower??.3),this.uniformLocs.u_volumetric_fog&&c.uniform1f(this.uniformLocs.u_volumetric_fog,f.volumetricFog??.15),this.uniformLocs.u_palette_seed&&c.uniform1f(this.uniformLocs.u_palette_seed,f.paletteSeed??0),c.drawArrays(c.TRIANGLES,0,3)}destroy(){if(this.gl){this.vao&&(this.gl.deleteVertexArray(this.vao),this.vao=null),this.vbo&&(this.gl.deleteBuffer(this.vbo),this.vbo=null),this.program&&(this.gl.deleteProgram(this.program),this.program=null);const p=this.gl.getExtension("WEBGL_lose_context");p&&p.loseContext(),this.gl=null}}}const tf="golden_ratio_user_prefs",ah=500;class nh{constructor(){this.samples=[],this.lastSampleTime=0,this.currentFractal="",this.currentStyle="",this.currentPalette="",this.currentCamera="",this.sessionStart=0,this.prefs=this.loadFromStorage(),this.sessionStart=performance.now()}getDefaultPrefs(){return{preferredZoomRange:{min:.5,max:8,avg:2},zoomSensitivity:1,rotationSpeed:.005,rotationStyle:"moderate",fractalWeights:{},renderStyleWeights:{},paletteWeights:{},cameraModeWeights:{},prefersTouch:!1,prefersScroll:!0,totalInteractionTime:0,sampleCount:0}}loadFromStorage(){try{const p=localStorage.getItem(tf);if(p)return{...this.getDefaultPrefs(),...JSON.parse(p)}}catch{}return this.getDefaultPrefs()}saveToStorage(){try{localStorage.setItem(tf,JSON.stringify(this.prefs))}catch{}}recordInteraction(p,f){const c=performance.now(),y=c-this.lastSampleTime;this.lastSampleTime=c;const b={timestamp:c,type:p,value:f,duration:y};this.samples.push(b),this.samples.length>ah&&this.samples.shift(),this.analyzeSample(b),this.prefs.sampleCount++,this.prefs.sampleCount%20===0&&this.saveToStorage()}analyzeSample(p){switch(p.type){case"zoom":this.analyzeZoom(p);break;case"rotate":this.analyzeRotation(p);break;case"fractal_change":this.analyzeFractalChange(p);break;case"style_change":this.analyzeStyleChange(p);break;case"palette_change":this.analyzePaletteChange(p);break;case"camera_change":this.analyzeCameraChange(p);break}}analyzeZoom(p){const f=p.value;this.prefs.preferredZoomRange.avg=this.prefs.preferredZoomRange.avg*.9+f*.1,this.prefs.preferredZoomRange.min=Math.min(this.prefs.preferredZoomRange.min,f),this.prefs.preferredZoomRange.max=Math.max(this.prefs.preferredZoomRange.max,f),this.prefs.zoomSensitivity=this.prefs.zoomSensitivity*.95+Math.abs(p.value)*.05}analyzeRotation(p){const f=Math.abs(p.value);this.prefs.rotationSpeed=this.prefs.rotationSpeed*.9+f*.1,f<.003?this.prefs.rotationStyle="careful":f<.01?this.prefs.rotationStyle="moderate":this.prefs.rotationStyle="fast"}analyzeFractalChange(p){const f=String(Math.round(p.value));this.prefs.fractalWeights[f]=(this.prefs.fractalWeights[f]||0)+1,this.currentFractal=f}analyzeStyleChange(p){const f=String(Math.round(p.value));this.prefs.renderStyleWeights[f]=(this.prefs.renderStyleWeights[f]||0)+1,this.currentStyle=f}analyzePaletteChange(p){const f=String(Math.round(p.value));this.prefs.paletteWeights[f]=(this.prefs.paletteWeights[f]||0)+1,this.currentPalette=f}analyzeCameraChange(p){const f=String(Math.round(p.value));this.prefs.cameraModeWeights[f]=(this.prefs.cameraModeWeights[f]||0)+1,this.currentCamera=f}getPreferred(p){let f=0,c=null;for(const[y,b]of Object.entries(p))b>f&&(f=b,c=y);return c}getAdaptedDefaults(){const p={};if(this.prefs.sampleCount>10){p.zoom=this.prefs.preferredZoomRange.avg,p.rotationSensitivity=this.prefs.rotationSpeed;const f=this.getPreferred(this.prefs.fractalWeights);f!==null&&(p.preferredFractal=Number(f));const c=this.getPreferred(this.prefs.renderStyleWeights);c!==null&&(p.preferredStyle=Number(c));const y=this.getPreferred(this.prefs.paletteWeights);y!==null&&(p.preferredPalette=Number(y));const b=this.getPreferred(this.prefs.cameraModeWeights);b!==null&&(p.preferredCamera=b)}return p}getPreferences(){return this.prefs}reset(){this.prefs=this.getDefaultPrefs(),this.samples=[],this.saveToStorage()}flush(){this.saveToStorage()}}const af=new nh,ih=({params:u,onParamsChange:p,onTelemetryUpdate:f,screenshotRequested:c,onScreenshotCaptured:y,forcedBackend:b="auto",onInteraction:w,onNextSpecimen:q,onPrevSpecimen:T,onEngineReady:m,scrollMode:E="feed"})=>{const k=R.useRef(null),B=R.useRef(null),L=typeof window<"u"&&(window!==window.top||/\bqoder\b/i.test(navigator.userAgent)||/\belectron\b/i.test(navigator.userAgent)),V=typeof window<"u"&&(/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)||navigator.maxTouchPoints>1&&window.innerWidth<1024),[ee,$]=R.useState(()=>b==="webgl2"?"webgl2":b==="webgpu"?L?"webgl2":"webgpu":"webgl2"),[F,le]=R.useState(!0),g=R.useRef(null),U=R.useRef(null),be=R.useRef("Initializing..."),ge=R.useRef(u);R.useEffect(()=>{ge.current=u},[u]);const ae=R.useRef(f);ae.current=f;const je=R.useRef(y);je.current=y;const Se=R.useRef(q);Se.current=q;const Ze=R.useRef(T);Ze.current=T;const Te=R.useRef(w);Te.current=w;const Ge=R.useRef(0),Qe=R.useRef(!1),Xe=R.useRef({x:0,y:0}),fe=R.useRef(null),S=R.useRef({x:0,y:0}),O=R.useRef(0),Z=.92,W=1e-4,re=R.useRef([]),h=R.useRef(0),A=R.useRef(null),X=R.useRef(0),Y=R.useRef(!1),K=R.useRef(new Set),ie=R.useRef(!1),de=R.useRef(!0),Fe=R.useRef(!1),Ee=R.useRef(!1);R.useEffect(()=>{Ee.current=c},[c]),R.useEffect(()=>{if(b==="webgl2")$("webgl2");else if(b==="webgpu"){if(L){console.warn("[FractalCanvas] WebGPU blocked in embedded browser — using WebGL2"),Y.current=!0,$("webgl2");return}Y.current=!1,$("webgpu")}else b==="auto"&&$("webgl2")},[b]);const Pt=R.useCallback(()=>{const G=B.current,P=k.current;if(!G||!P)return;const ne=L||V?1.5:2,ue=Math.min(window.devicePixelRatio||1,ne),qe=P.clientWidth||window.innerWidth||800,Ne=P.clientHeight||window.innerHeight||600,pt=Math.floor(qe*ue),we=Math.floor(Ne*ue);(G.width!==pt||G.height!==we)&&(G.width=Math.max(pt,320),G.height=Math.max(we,240))},[]);R.useEffect(()=>{const G=B.current;if(!G)return;Pt();let P=!1;const ne=setTimeout(()=>{P||(console.warn("[FractalCanvas] Force-hiding loading overlay after 12s"),le(!1))},12e3),ue=setTimeout(()=>{!Fe.current&&!P&&(console.error("[FractalCanvas] Engine setup timed out after 8s — GPU unavailable"),console.error("[FractalCanvas] activeEngineType=",ee,"webgpuFailed=",Y.current,"isDestroyed=",P))},8e3);async function qe(){if(!G)return;if(console.info("[FractalCanvas] Setup starting, activeEngineType=",ee),le(!0),Fe.current=!1,g.current&&(g.current.destroy(),g.current=null),U.current&&(U.current.destroy(),U.current=null),ee==="webgpu"){console.info("[FractalCanvas] Attempting WebGPU init...");const ft=new Qs(G),oa=await ft.init();if(console.info("[FractalCanvas] WebGPU init result:",oa),oa&&!P){g.current=ft,Fe.current=!0,be.current="WebGPU (WGSL)",le(!1),m==null||m();return}else{console.warn("[FractalCanvas] WebGPU init failed, falling back to WebGL2"),Y.current=!0,P?le(!1):$("webgl2");return}}console.info("[FractalCanvas] Attempting WebGL2 init...");const tt=new th(G),Zt=tt.init();console.info("[FractalCanvas] WebGL2 init result:",Zt,"isDestroyed:",P),Zt&&!P?(U.current=tt,Fe.current=!0,be.current="WebGL2 (GLSL)",le(!1),m==null||m()):(console.error("[FractalCanvas] WebGL2 init failed — no GPU engine available"),le(!1),m==null||m())}qe().catch(tt=>{console.error("[FractalCanvas] Engine setup crashed:",tt),le(!1),m==null||m()});const Ne=tt=>{tt.preventDefault(),console.warn("GPU context lost, pausing rendering..."),ie.current=!0},pt=()=>{console.log("GPU context restored, re-initializing engine..."),ie.current=!1,qe()};G.addEventListener("webglcontextlost",Ne,!1),G.addEventListener("webglcontextrestored",pt,!1);const we=k.current;let vt=null;return we&&(vt=new ResizeObserver(()=>{P||Pt()}),vt.observe(we)),()=>{var tt,Zt;P=!0,clearTimeout(ue),clearTimeout(ne),G.removeEventListener("webglcontextlost",Ne),G.removeEventListener("webglcontextrestored",pt),vt&&vt.disconnect(),(tt=g.current)==null||tt.destroy(),(Zt=U.current)==null||Zt.destroy()}},[ee,Pt]),R.useEffect(()=>{let G=!0,P=performance.now();const ne=()=>{de.current=!document.hidden,de.current&&(P=performance.now())};document.addEventListener("visibilitychange",ne);const ue=qe=>{var tt,Zt;if(!G)return;if(ie.current){A.current=requestAnimationFrame(ue);return}if(!de.current){A.current=requestAnimationFrame(ue);return}if(!Fe.current){setTimeout(()=>{G&&(A.current=requestAnimationFrame(ue))},1e3);return}const Ne=ge.current,pt=qe-P,we=Ne.targetFps||60,vt=we>=240?0:1e3/we;if(vt<=0||pt>=vt-.75){const ft=Math.min(pt,100);P=qe,X.current+=ft/1e3;const oa=X.current;if(Ne.cameraMode==="flyThrough"){const Dt=Ne.rotX,sa=Ne.rotY,ca=Math.cos(Dt),It=Math.sin(Dt),ua=Math.cos(sa),pa=Math.sin(sa),mt=[It*ua,pa,-ca*ua],Qt=[ca,0,It],ea=[0,1,0];let at=1.4*(ft/1e3);(K.current.has("ShiftLeft")||K.current.has("ShiftRight"))&&(at*=2.8);let wt=0,ta=0,Ot=0;(K.current.has("KeyW")||K.current.has("ArrowUp"))&&(wt+=mt[0]*at,ta+=mt[1]*at,Ot+=mt[2]*at),(K.current.has("KeyS")||K.current.has("ArrowDown"))&&(wt-=mt[0]*at,ta-=mt[1]*at,Ot-=mt[2]*at),(K.current.has("KeyA")||K.current.has("ArrowLeft"))&&(wt-=Qt[0]*at,Ot-=Qt[2]*at),(K.current.has("KeyD")||K.current.has("ArrowRight"))&&(wt+=Qt[0]*at,Ot+=Qt[2]*at),(K.current.has("KeyE")||K.current.has("Space"))&&(ta+=ea[1]*at),(K.current.has("KeyQ")||K.current.has("KeyC"))&&(ta-=ea[1]*at),(wt!==0||ta!==0||Ot!==0)&&(ge.current={...Ne,camPosX:(Ne.camPosX??0)+wt,camPosY:(Ne.camPosY??0)+ta,camPosZ:(Ne.camPosZ??0)+Ot})}const ol=Ne.autoRotate?oa*Ne.autoRotateSpeed*.12:0,Nr=Ne.autoRotate?Math.sin(oa*.18)*.06:0;let sl=0,Ca=0;if(!Qe.current&&(Math.abs(S.current.x)>W||Math.abs(S.current.y)>W)){const Dt=Ne.zoom,sa=.0045*Math.max(.12,Math.min(1,Dt/2.8)),ca=ft;sl=S.current.x*ca*sa*.5,Ca=S.current.y*ca*sa*.5,S.current.x*=Z,S.current.y*=Z,Math.abs(S.current.x)<W&&(S.current.x=0),Math.abs(S.current.y)<W&&(S.current.y=0)}const dt={...Ne,rotX:Ne.rotX+ol+sl,rotY:Math.max(-1.52,Math.min(1.52,Ne.rotY+Nr+Ca))},Ke=B.current;if(Ke&&Ke.width>0&&Ke.height>0&&(g.current?g.current.render(oa,dt):U.current&&U.current.render(oa,dt)),Ee.current&&Ke)try{const Dt=Ke.toDataURL("image/png");(tt=je.current)==null||tt.call(je,Dt)}catch(Dt){console.error("Screenshot capture failed",Dt)}const Je=re.current;if(Je.push(ft),Je.length>72&&Je.shift(),qe-h.current>250){h.current=qe;const Dt=Je.reduce((at,wt)=>at+wt,0)/Je.length,sa=ft>0?Math.round(1e3/ft):0,ca=Dt>0?Math.round(1e3/Dt):0,It=[...Je].sort((at,wt)=>wt-at),ua=Math.floor(It.length*.05),pa=It[ua]||ft,mt=pa>0?Math.round(1e3/pa):0,Qt=g.current?g.current.adapterInfo:U.current?U.current.rendererInfo:"GPU Engine",ea=ee==="webgpu"?"WebGPU (WGSL)":"WebGL2 (GLSL)";(Zt=ae.current)==null||Zt.call(ae,{fps:sa,avgFps:ca,frameTimeMs:parseFloat(ft.toFixed(2)),onePercentLow:mt,backend:ea,adapterName:Qt,resolution:[(Ke==null?void 0:Ke.width)||0,(Ke==null?void 0:Ke.height)||0],drsScale:1,targetFps:u.targetFps,interiorDistance:0})}}A.current=requestAnimationFrame(ue)};return A.current=requestAnimationFrame(ue),()=>{G=!1,document.removeEventListener("visibilitychange",ne),A.current&&cancelAnimationFrame(A.current)}},[ee]),R.useEffect(()=>{const G=ne=>{var ue,qe,Ne;((ue=ne.target)==null?void 0:ue.tagName)!=="INPUT"&&(ne.repeat||(K.current.add(ne.code),ge.current.cameraMode!=="flyThrough"&&(ne.key===" "||ne.key==="ArrowRight"||ne.key==="ArrowDown"||ne.key==="PageDown"?(ne.preventDefault(),(qe=Se.current)==null||qe.call(Se)):(ne.key==="ArrowLeft"||ne.key==="ArrowUp"||ne.key==="PageUp")&&(ne.preventDefault(),(Ne=Ze.current)==null||Ne.call(Ze)))))},P=ne=>{K.current.delete(ne.code)};return window.addEventListener("keydown",G),window.addEventListener("keyup",P),()=>{window.removeEventListener("keydown",G),window.removeEventListener("keyup",P)}},[]);const Ma=G=>{Qe.current=!0,Xe.current={x:G.clientX,y:G.clientY},S.current={x:0,y:0},O.current=performance.now(),G.target.setPointerCapture(G.pointerId)},nn=G=>{var vt;if(!Qe.current)return;const P=G.clientX-Xe.current.x,ne=G.clientY-Xe.current.y,ue=performance.now(),qe=Math.max(1,ue-O.current);O.current=ue,Xe.current={x:G.clientX,y:G.clientY};const Ne=Math.hypot(P,ne);ue-Ge.current>300&&(Ge.current=ue,(vt=Te.current)==null||vt.call(Te,0,Ne));const pt=ge.current.zoom,we=.0045*Math.max(.12,Math.min(1,pt/2.8));S.current={x:P/qe,y:ne/qe},p(tt=>({...tt,rotX:tt.rotX+P*we,rotY:Math.max(-1.52,Math.min(1.52,tt.rotY+ne*we))})),af.recordInteraction("rotate",Math.hypot(P,ne)/qe)},ln=G=>{Qe.current=!1;try{G.target.releasePointerCapture(G.pointerId)}catch{}};R.useRef(0);const Vt=G=>{var ne;G.preventDefault();const P=Math.exp(Math.sign(G.deltaY)*Math.min(Math.abs(G.deltaY)*.0018,.28));(ne=Te.current)==null||ne.call(Te,Math.abs(G.deltaY)*.02,0),p(ue=>({...ue,zoom:Math.max(.02,Math.min(64,ue.zoom*P))})),af.recordInteraction("zoom",Math.log(P)*10)},rn=G=>{var P;if(G.preventDefault(),G.touches.length===2){const ne=G.touches[0],ue=G.touches[1],qe=Math.hypot(ne.clientX-ue.clientX,ne.clientY-ue.clientY);if(fe.current!==null&&fe.current>5){const Ne=fe.current/Math.max(qe,1),pt=Math.pow(Ne,.95);(P=Te.current)==null||P.call(Te,Math.abs(fe.current-qe)*.04,0),p(we=>({...we,zoom:Math.max(.02,Math.min(64,we.zoom*pt))}))}fe.current=qe}},H=G=>{G.preventDefault(),fe.current=null};return l.jsxs("div",{ref:k,id:"fractal-canvas-container",className:"absolute inset-0 w-full h-full overflow-hidden bg-black select-none touch-none cursor-grab active:cursor-grabbing",children:[F&&l.jsx("div",{id:"gpu-pipeline-loading-overlay",className:"absolute inset-0 z-10 flex flex-col items-center justify-center bg-neutral-950/60 backdrop-blur-xs pointer-events-none transition-opacity duration-300",children:l.jsxs("div",{className:"flex items-center gap-2 px-4 py-2 rounded-full bg-neutral-900/90 border border-amber-500/30 text-amber-300 text-xs font-mono shadow-2xl animate-pulse",children:[l.jsx("div",{className:"w-2 h-2 rounded-full bg-amber-400 animate-ping"}),l.jsxs("span",{children:["Initializing GPU (",ee==="webgpu"?"WebGPU WGSL":"WebGL2 GLSL",")..."]})]})}),!F&&!Fe.current&&l.jsx("div",{className:"absolute inset-0 z-[60] flex flex-col items-center justify-center bg-neutral-950/90 pointer-events-auto",children:l.jsxs("div",{className:"px-6 py-4 rounded-xl bg-red-950/80 border border-red-500/40 text-red-300 text-sm font-mono text-center max-w-md",children:[l.jsx("div",{className:"text-base font-bold mb-2",children:"GPU Unavailable"}),l.jsxs("div",{className:"text-xs opacity-80",children:["Neither WebGPU nor WebGL2 could initialize.",l.jsx("br",{}),"This browser/environment may not support hardware-accelerated rendering.",l.jsx("br",{}),"Try opening this page in Chrome/Edge with GPU acceleration enabled."]})]})}),l.jsx("canvas",{ref:B,id:"fractal-canvas",className:"w-full h-full block touch-none",onPointerDown:Ma,onPointerMove:nn,onPointerUp:ln,onPointerCancel:ln,onWheel:Vt,onTouchStart:G=>G.preventDefault(),onTouchMove:rn,onTouchEnd:H},ee)]})};/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ch=R.forwardRef(({color:u="currentColor",size:p=24,strokeWidth:f=2,absoluteStrokeWidth:c,className:y="",children:b,iconNode:w,...q},T)=>R.createElement("svg",{ref:T,...sh,width:p,height:p,stroke:u,strokeWidth:c?Number(f)*24/Number(p):f,className:hf("lucide",y),...!b&&!oh(q)&&{"aria-hidden":"true"},...q},[...w.map(([m,E])=>R.createElement(m,E)),...Array.isArray(b)?b:[b]]));/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ce=(u,p)=>{const f=R.forwardRef(({className:c,...y},b)=>R.createElement(ch,{ref:b,iconNode:p,className:hf(`lucide-${lh(nf(u))}`,`lucide-${u}`,c),...y}));return f.displayName=nf(u),f};/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Th=[["path",{d:"m9 18 6-6-6-6",key:"mthhwq"}]],yf=ce("chevron-right",Th);/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ah=[["path",{d:"m18 15-6-6-6 6",key:"153udz"}]],Mh=ce("chevron-up",Ah);/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Fh=[["path",{d:"M12 3q1 4 4 6.5t3 5.5a1 1 0 0 1-14 0 5 5 0 0 1 1-3 1 1 0 0 0 5 0c0-2-1.5-3-1.5-5q0-2 2.5-4",key:"1slcih"}]],Bh=ce("flame",Fh);/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
