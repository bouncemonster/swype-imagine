 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Qp;function Um(){return Qp||(Qp=1,(function(p){function s(w,q){var T=w.length;w.push(q);e:for(;0<T;){var V=T-1>>>1,I=w[V];if(0<g(I,q))w[V]=q,w[T]=I,T=V;else break e}}function f(w){return w.length===0?null:w[0]}function u(w){if(w.length===0)return null;var q=w[0],T=w.pop();if(T!==q){w[0]=T;e:for(var V=0,I=w.length,m=I>>>1;V<m;){var R=2*(V+1)-1,G=w[R],X=R+1,ae=w[X];if(0>g(G,T))X<I&&0>g(ae,G)?(w[V]=ae,w[X]=T,V=X):(w[V]=G,w[R]=T,V=R);else if(X<I&&0>g(ae,T))w[V]=ae,w[X]=T,V=X;else break e}}return q}function g(w,q){var T=w.sortIndex-q.sortIndex;return T!==0?T:w.id-q.id}if(p.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var b=performance;p.unstable_now=function(){return b.now()}}else{var x=Date,A=x.now();p.unstable_now=function(){return x.now()-A}}var D=[],v=[],F=1,E=null,L=3,U=!1,Y=!1,K=!1,W=!1,B=typeof setTimeout=="function"?setTimeout:null,ce=typeof clearTimeout=="function"?clearTimeout:null,_=typeof setImmediate<"u"?setImmediate:null;function P(w){for(var q=f(v);q!==null;){if(q.callback===null)u(v);else if(q.startTime<=w)u(v),q.sortIndex=q.expirationTime,s(D,q);else break;q=f(v)}}function he(w){if(K=!1,P(w),!Y)if(f(D)!==null)Y=!0,De||(De=!0,Ge());else{var q=f(v);q!==null&&oe(he,q.startTime-w)}}var De=!1,ee=-1,Re=5,Fe=-1;function Ue(){return W?!0:!(p.unstable_now()-Fe<Re)}function Xe(){if(W=!1,De){var w=p.unstable_now();Fe=w;var q=!0;try{e:{Y=!1,K&&(K=!1,ce(ee),ee=-1),U=!0;var T=L;try{t:{for(P(w),E=f(D);E!==null&&!(E.expirationTime>w&&Ue());){var V=E.callback;if(typeof V=="function"){E.callback=null,L=E.priorityLevel;var I=V(E.expirationTime<=w);if(w=p.unstable_now(),typeof I=="function"){E.callback=I,P(w),q=!0;break t}E===f(D)&&u(D),P(w)}else u(D);E=f(D)}if(E!==null)q=!0;else{var m=f(v);m!==null&&oe(he,m.startTime-w),q=!1}}break e}finally{E=null,L=T,U=!1}q=void 0}}finally{q?Ge():De=!1}}}var Ge;if(typeof _=="function")Ge=function(){_(Xe)};else if(typeof MessageChannel<"u"){var ue=new MessageChannel,qe=ue.port2;ue.port1.onmessage=Xe,Ge=function(){qe.postMessage(null)}}else Ge=function(){B(Xe,0)};function oe(w,q){ee=B(function(){w(p.unstable_now())},q)}p.unstable_IdlePriority=5,p.unstable_ImmediatePriority=1,p.unstable_LowPriority=4,p.unstable_NormalPriority=3,p.unstable_Profiling=null,p.unstable_UserBlockingPriority=2,p.unstable_cancelCallback=function(w){w.callback=null},p.unstable_forceFrameRate=function(w){0>w||125<w?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Re=0<w?Math.floor(1e3/w):5},p.unstable_getCurrentPriorityLevel=function(){return L},p.unstable_next=function(w){switch(L){case 1:case 2:case 3:var q=3;break;default:q=L}var T=L;L=q;try{return w()}finally{L=T}},p.unstable_requestPaint=function(){W=!0},p.unstable_runWithPriority=function(w,q){switch(w){case 1:case 2:case 3:case 4:case 5:break;default:w=3}var T=L;L=w;try{return q()}finally{L=T}},p.unstable_scheduleCallback=function(w,q,T){var V=p.unstable_now();switch(typeof T=="object"&&T!==null?(T=T.delay,T=typeof T=="number"&&0<T?V+T:V):T=V,w){case 1:var I=-1;break;case 2:I=250;break;case 5:I=1073741823;break;case 4:I=1e4;break;default:I=5e3}return I=T+I,w={id:F++,callback:q,priorityLevel:w,startTime:T,expirationTime:I,sortIndex:-1},T>V?(w.sortIndex=T,s(v,w),f(D)===null&&w===f(v)&&(K?(ce(ee),ee=-1):K=!0,oe(he,T-V))):(w.sortIndex=I,s(D,w),Y||U||(Y=!0,De||(De=!0,Ge()))),w},p.unstable_shouldYield=Ue,p.unstable_wrapCallback=function(w){var q=L;return function(){var T=L;L=q;try{return w.apply(this,arguments)}finally{L=T}}}})(Vs)),Vs}var Kp;function Bm(){return Kp||(Kp=1,Xs.exports=Um()),Xs.exports}var Zs={exports:{}},ie={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Wp;function Lm(){if(Wp)return ie;Wp=1;var p=Symbol.for("react.transitional.element"),s=Symbol.for("react.portal"),f=Symbol.for("react.fragment"),u=Symbol.for("react.strict_mode"),g=Symbol.for("react.profiler"),b=Symbol.for("react.consumer"),x=Symbol.for("react.context"),A=Symbol.for("react.forward_ref"),D=Symbol.for("react.suspense"),v=Symbol.for("react.memo"),F=Symbol.for("react.lazy"),E=Symbol.for("react.activity"),L=Symbol.iterator;function U(m){return m===null||typeof m!="object"?null:(m=L&&m[L]||m["@@iterator"],typeof m=="function"?m:null)}var Y={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},K=Object.assign,W={};function B(m,R,G){this.props=m,this.context=R,this.refs=W,this.updater=G||Y}B.prototype.isReactComponent={},B.prototype.setState=function(m,R){if(typeof m!="object"&&typeof m!="function"&&m!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,m,R,"setState")},B.prototype.forceUpdate=function(m){this.updater.enqueueForceUpdate(this,m,"forceUpdate")};function ce(){}ce.prototype=B.prototype;function _(m,R,G){this.props=m,this.context=R,this.refs=W,this.updater=G||Y}var P=_.prototype=new ce;P.constructor=_,K(P,B.prototype),P.isPureReactComponent=!0;var he=Array.isArray;function De(){}var ee={H:null,A:null,T:null,S:null},Re=Object.prototype.hasOwnProperty;function Fe(m,R,G){var X=G.ref;return{$$typeof:p,type:m,key:R,ref:X!==void 0?X:null,props:G}}function Ue(m,R){return Fe(m.type,R,m.props)}function Xe(m){return typeof m=="object"&&m!==null&&m.$$typeof===p}function Ge(m){var R={"=":"=0",":":"=2"};return"$"+m.replace(/[=:]/g,function(G){return R[G]})}var ue=/\/+/g;function qe(m,R){return typeof m=="object"&&m!==null&&m.key!=null?Ge(""+m.key):R.toString(36)}function oe(m){switch(m.status){case"fulfilled":return m.value;case"rejected":throw m.reason;default:switch(typeof m.status=="string"?m.then(De,De):(m.status="pending",m.then(function(R){m.status==="pending"&&(m.status="fulfilled",m.value=R)},function(R){m.status==="pending"&&(m.status="rejected",m.reason=R)})),m.status){case"fulfilled":return m.value;case"rejected":throw m.reason}}throw m}function w(m,R,G,X,ae){var ne=typeof m;(ne==="undefined"||ne==="boolean")&&(m=null);var fe=!1;if(m===null)fe=!0;else switch(ne){case"bigint":case"string":case"number":fe=!0;break;case"object":switch(m.$$typeof){case p:case s:fe=!0;break;case F:return fe=m._init,w(fe(m._payload),R,G,X,ae)}}if(fe)return ae=ae(m),fe=X===""?"."+qe(m,0):X,he(ae)?(G="",fe!=null&&(G=fe.replace(ue,"$&/")+"/"),w(ae,R,G,"",function(la){return la})):ae!=null&&(Xe(ae)&&(ae=Ue(ae,G+(ae.key==null||m&&m.key===ae.key?"":(""+ae.key).replace(ue,"$&/")+"/")+fe)),R.push(ae)),1;fe=0;var We=X===""?".":X+":";if(he(m))for(var ze=0;ze<m.length;ze++)X=m[ze],ne=We+qe(X,ze),fe+=w(X,R,G,ne,ae);else if(ze=U(m),typeof ze=="function")for(m=ze.call(m),ze=0;!(X=m.next()).done;)X=X.value,ne=We+qe(X,ze++),fe+=w(X,R,G,ne,ae);else if(ne==="object"){if(typeof m.then=="function")return w(oe(m),R,G,X,ae);throw R=String(m),Error("Objects are not valid as a React child (found: "+(R==="[object Object]"?"object with keys {"+Object.keys(m).join(", ")+"}":R)+"). If you meant to render a collection of children, use an array instead.")}return fe}function q(m,R,G){if(m==null)return m;var X=[],ae=0;return w(m,X,"","",function(ne){return R.call(G,ne,ae++)}),X}function T(m){if(m._status===-1){var R=m._result;R=R(),R.then(function(G){(m._status===0||m._status===-1)&&(m._status=1,m._result=G)},function(G){(m._status===0||m._status===-1)&&(m._status=2,m._result=G)}),m._status===-1&&(m._status=0,m._result=R)}if(m._status===1)return m._result.default;throw m._result}var V=typeof reportError=="function"?reportError:function(m){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var R=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof m=="object"&&m!==null&&typeof m.message=="string"?String(m.message):String(m),error:m});if(!window.dispatchEvent(R))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",m);return}console.error(m)},I={map:q,forEach:function(m,R,G){q(m,function(){R.apply(this,arguments)},G)},count:function(m){var R=0;return q(m,function(){R++}),R},toArray:function(m){return q(m,function(R){return R})||[]},only:function(m){if(!Xe(m))throw Error("React.Children.only expected to receive a single React element child.");return m}};return ie.Activity=E,ie.Children=I,ie.Component=B,ie.Fragment=f,ie.Profiler=g,ie.PureComponent=_,ie.StrictMode=u,ie.Suspense=D,ie.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=ee,ie.__COMPILER_RUNTIME={__proto__:null,c:function(m){return ee.H.useMemoCache(m)}},ie.cache=function(m){return function(){return m.apply(null,arguments)}},ie.cacheSignal=function(){return null},ie.cloneElement=function(m,R,G){if(m==null)throw Error("The argument must be a React element, but you passed "+m+".");var X=K({},m.props),ae=m.key;if(R!=null)for(ne in R.key!==void 0&&(ae=""+R.key),R)!Re.call(R,ne)||ne==="key"||ne==="__self"||ne==="__source"||ne==="ref"&&R.ref===void 0||(X[ne]=R[ne]);var ne=arguments.length-2;if(ne===1)X.children=G;else if(1<ne){for(var fe=Array(ne),We=0;We<ne;We++)fe[We]=arguments[We+2];X.children=fe}return Fe(m.type,ae,X)},ie.createContext=function(m){return m={$$typeof:x,_currentValue:m,_currentValue2:m,_threadCount:0,Provider:null,Consumer:null},m.Provider=m,m.Consumer={$$typeof:b,_context:m},m},ie.createElement=function(m,R,G){var X,ae={},ne=null;if(R!=null)for(X in R.key!==void 0&&(ne=""+R.key),R)Re.call(R,X)&&X!=="key"&&X!=="__self"&&X!=="__source"&&(ae[X]=R[X]);var fe=arguments.length-2;if(fe===1)ae.children=G;else if(1<fe){for(var We=Array(fe),ze=0;ze<fe;ze++)We[ze]=arguments[ze+2];ae.children=We}if(m&&m.defaultProps)for(X in fe=m.defaultProps,fe)ae[X]===void 0&&(ae[X]=fe[X]);return Fe(m,ne,ae)},ie.createRef=function(){return{current:null}},ie.forwardRef=function(m){return{$$typeof:A,render:m}},ie.isValidElement=Xe,ie.lazy=function(m){return{$$typeof:F,_payload:{_status:-1,_result:m},_init:T}},ie.memo=function(m,R){return{$$typeof:v,type:m,compare:R===void 0?null:R}},ie.startTransition=function(m){var R=ee.T,G={};ee.T=G;try{var X=m(),ae=ee.S;ae!==null&&ae(G,X),typeof X=="object"&&X!==null&&typeof X.then=="function"&&X.then(De,V)}catch(ne){V(ne)}finally{R!==null&&G.types!==null&&(R.types=G.types),ee.T=R}},ie.unstable_useCacheRefresh=function(){return ee.H.useCacheRefresh()},ie.use=function(m){return ee.H.use(m)},ie.useActionState=function(m,R,G){return ee.H.useActionState(m,R,G)},ie.useCallback=function(m,R){return ee.H.useCallback(m,R)},ie.useContext=function(m){return ee.H.useContext(m)},ie.useDebugValue=function(){},ie.useDeferredValue=function(m,R){return ee.H.useDeferredValue(m,R)},ie.useEffect=function(m,R){return ee.H.useEffect(m,R)},ie.useEffectEvent=function(m){return ee.H.useEffectEvent(m)},ie.useId=function(){return ee.H.useId()},ie.useImperativeHandle=function(m,R,G){return ee.H.useImperativeHandle(m,R,G)},ie.useInsertionEffect=function(m,R){return ee.H.useInsertionEffect(m,R)},ie.useLayoutEffect=function(m,R){return ee.H.useLayoutEffect(m,R)},ie.useMemo=function(m,R){return ee.H.useMemo(m,R)},ie.useOptimistic=function(m,R){return ee.H.useOptimistic(m,R)},ie.useReducer=function(m,R,G){return ee.H.useReducer(m,R,G)},ie.useRef=function(m){return ee.H.useRef(m)},ie.useState=function(m){return ee.H.useState(m)},ie.useSyncExternalStore=function(m,R,G){return ee.H.useSyncExternalStore(m,R,G)},ie.useTransition=function(){return ee.H.useTransition()},ie.version="19.2.8",ie}var Ip;function $s(){return Ip||(Ip=1,Zs.exports=Lm()),Zs.exports}var Qs={exports:{}},yt={};/**
 * @license React
...
fn fs_main(in: VertexOutput) -> @location(0) vec4<f32> {
  ...
  if (hit || nearMiss) {
    ...
    let viewDependent = dot(n, rd) * 0.5 + 0.5;
    let viewHash = fract(sin(dot(n * 23.7, vec3<f32>(45.678, 12.345, 67.890))) * 98765.4321);
    ...
    let phase = fract(
      ...
      u.time * 0.04 + seedAnim * 0.01  // Animation
    );
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ih=[["path",{d:"M8 3H5a2 2 0 0 0-2 2v3",key:"1dcmit"}],["path",{d:"M21 8V5a2 2 0 0 0-2-2h-3",key:"1e4gt3"}],["path",{d:"M3 16v3a2 2 0 0 0 2 2h3",key:"wsl5sc"}],["path",{d:"M16 21h3a2 2 0 0 0 2-2v-3",key:"18trek"}]],Jh=re("maximize",Ih);/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
