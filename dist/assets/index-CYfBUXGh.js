 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Zp;function Gm(){return Zp||(Zp=1,(function(u){function p(S,O){var Z=S.length;S.push(O);e:for(;0<Z;){var W=Z-1>>>1,re=S[W];if(0<y(re,O))S[W]=O,S[Z]=re,Z=W;else break e}}function f(S){return S.length===0?null:S[0]}function c(S){if(S.length===0)return null;var O=S[0],Z=S.pop();if(Z!==O){S[0]=Z;e:for(var W=0,re=S.length,h=re>>>1;W<h;){var T=2*(W+1)-1,X=S[T],Y=T+1,K=S[Y];if(0>y(X,Z))Y<re&&0>y(K,X)?(S[W]=K,S[Y]=Z,W=Y):(S[W]=X,S[T]=Z,W=T);else if(Y<re&&0>y(K,Z))S[W]=K,S[Y]=Z,W=Y;else break e}}return O}function y(S,O){var Z=S.sortIndex-O.sortIndex;return Z!==0?Z:S.id-O.id}if(u.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var b=performance;u.unstable_now=function(){return b.now()}}else{var w=Date,q=w.now();u.unstable_now=function(){return w.now()-q}}var A=[],m=[],E=1,k=null,B=3,L=!1,V=!1,ee=!1,$=!1,F=typeof setTimeout=="function"?setTimeout:null,le=typeof clearTimeout=="function"?clearTimeout:null,g=typeof setImmediate<"u"?setImmediate:null;function U(S){for(var O=f(m);O!==null;){if(O.callback===null)c(m);else if(O.startTime<=S)c(m),O.sortIndex=O.expirationTime,p(A,O);else break;O=f(m)}}function be(S){if(ee=!1,U(S),!V)if(f(A)!==null)V=!0,ge||(ge=!0,Ge());else{var O=f(m);O!==null&&fe(be,O.startTime-S)}}var ge=!1,ae=-1,je=5,Se=-1;function Ze(){return $?!0:!(u.unstable_now()-Se<je)}function Ae(){if($=!1,ge){var S=u.unstable_now();Se=S;var O=!0;try{e:{V=!1,ee&&(ee=!1,le(ae),ae=-1),L=!0;var Z=B;try{t:{for(U(S),k=f(A);k!==null&&!(k.expirationTime>S&&Ze());){var W=k.callback;if(typeof W=="function"){k.callback=null,B=k.priorityLevel;var re=W(k.expirationTime<=S);if(S=u.unstable_now(),typeof re=="function"){k.callback=re,U(S),O=!0;break t}k===f(A)&&c(A),U(S)}else c(A);k=f(A)}if(k!==null)O=!0;else{var h=f(m);h!==null&&fe(be,h.startTime-S),O=!1}}break e}finally{k=null,B=Z,L=!1}O=void 0}}finally{O?Ge():ge=!1}}}var Ge;if(typeof g=="function")Ge=function(){g(Ae)};else if(typeof MessageChannel<"u"){var Qe=new MessageChannel,Xe=Qe.port2;Qe.port1.onmessage=Ae,Ge=function(){Xe.postMessage(null)}}else Ge=function(){F(Ae,0)};function fe(S,O){ae=F(function(){S(u.unstable_now())},O)}u.unstable_IdlePriority=5,u.unstable_ImmediatePriority=1,u.unstable_LowPriority=4,u.unstable_NormalPriority=3,u.unstable_Profiling=null,u.unstable_UserBlockingPriority=2,u.unstable_cancelCallback=function(S){S.callback=null},u.unstable_forceFrameRate=function(S){0>S||125<S?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):je=0<S?Math.floor(1e3/S):5},u.unstable_getCurrentPriorityLevel=function(){return B},u.unstable_next=function(S){switch(B){case 1:case 2:case 3:var O=3;break;default:O=B}var Z=B;B=O;try{return S()}finally{B=Z}},u.unstable_requestPaint=function(){$=!0},u.unstable_runWithPriority=function(S,O){switch(S){case 1:case 2:case 3:case 4:case 5:break;default:S=3}var Z=B;B=S;try{return O()}finally{B=Z}},u.unstable_scheduleCallback=function(S,O,Z){var W=u.unstable_now();switch(typeof Z=="object"&&Z!==null?(Z=Z.delay,Z=typeof Z=="number"&&0<Z?W+Z:W):Z=W,S){case 1:var re=-1;break;case 2:re=250;break;case 5:re=1073741823;break;case 4:re=1e4;break;default:re=5e3}return re=Z+re,S={id:E++,callback:O,priorityLevel:S,startTime:Z,expirationTime:re,sortIndex:-1},Z>W?(S.sortIndex=Z,p(m,S),f(A)===null&&S===f(m)&&(ee?(le(ae),ae=-1):ee=!0,fe(be,Z-W))):(S.sortIndex=re,p(A,S),V||L||(V=!0,ge||(ge=!0,Ge()))),S},u.unstable_shouldYield=Ze,u.unstable_wrapCallback=function(S){var O=B;return function(){var Z=B;B=O;try{return S.apply(this,arguments)}finally{B=Z}}}})(Bs)),Bs}var Qp;function Hm(){return Qp||(Qp=1,Fs.exports=Gm()),Fs.exports}var Gs={exports:{}},oe={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Kp;function Ym(){if(Kp)return oe;Kp=1;var u=Symbol.for("react.transitional.element"),p=Symbol.for("react.portal"),f=Symbol.for("react.fragment"),c=Symbol.for("react.strict_mode"),y=Symbol.for("react.profiler"),b=Symbol.for("react.consumer"),w=Symbol.for("react.context"),q=Symbol.for("react.forward_ref"),A=Symbol.for("react.suspense"),m=Symbol.for("react.memo"),E=Symbol.for("react.lazy"),k=Symbol.for("react.activity"),B=Symbol.iterator;function L(h){return h===null||typeof h!="object"?null:(h=B&&h[B]||h["@@iterator"],typeof h=="function"?h:null)}var V={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},ee=Object.assign,$={};function F(h,T,X){this.props=h,this.context=T,this.refs=$,this.updater=X||V}F.prototype.isReactComponent={},F.prototype.setState=function(h,T){if(typeof h!="object"&&typeof h!="function"&&h!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,h,T,"setState")},F.prototype.forceUpdate=function(h){this.updater.enqueueForceUpdate(this,h,"forceUpdate")};function le(){}le.prototype=F.prototype;function g(h,T,X){this.props=h,this.context=T,this.refs=$,this.updater=X||V}var U=g.prototype=new le;U.constructor=g,ee(U,F.prototype),U.isPureReactComponent=!0;var be=Array.isArray;function ge(){}var ae={H:null,A:null,T:null,S:null},je=Object.prototype.hasOwnProperty;function Se(h,T,X){var Y=X.ref;return{$$typeof:u,type:h,key:T,ref:Y!==void 0?Y:null,props:X}}function Ze(h,T){return Se(h.type,T,h.props)}function Ae(h){return typeof h=="object"&&h!==null&&h.$$typeof===u}function Ge(h){var T={"=":"=0",":":"=2"};return"$"+h.replace(/[=:]/g,function(X){return T[X]})}var Qe=/\/+/g;function Xe(h,T){return typeof h=="object"&&h!==null&&h.key!=null?Ge(""+h.key):T.toString(36)}function fe(h){switch(h.status){case"fulfilled":return h.value;case"rejected":throw h.reason;default:switch(typeof h.status=="string"?h.then(ge,ge):(h.status="pending",h.then(function(T){h.status==="pending"&&(h.status="fulfilled",h.value=T)},function(T){h.status==="pending"&&(h.status="rejected",h.reason=T)})),h.status){case"fulfilled":return h.value;case"rejected":throw h.reason}}throw h}function S(h,T,X,Y,K){var ie=typeof h;(ie==="undefined"||ie==="boolean")&&(h=null);var de=!1;if(h===null)de=!0;else switch(ie){case"bigint":case"string":case"number":de=!0;break;case"object":switch(h.$$typeof){case u:case p:de=!0;break;case E:return de=h._init,S(de(h._payload),T,X,Y,K)}}if(de)return K=K(h),de=Y===""?"."+Xe(h,0):Y,be(K)?(X="",de!=null&&(X=de.replace(Qe,"$&/")+"/"),S(K,T,X,"",function(Pt){return Pt})):K!=null&&(Ae(K)&&(K=Ze(K,X+(K.key==null||h&&h.key===K.key?"":(""+K.key).replace(Qe,"$&/")+"/")+de)),T.push(K)),1;de=0;var Fe=Y===""?".":Y+":";if(be(h))for(var Ee=0;Ee<h.length;Ee++)Y=h[Ee],ie=Fe+Xe(Y,Ee),de+=S(Y,T,X,ie,K);else if(Ee=L(h),typeof Ee=="function")for(h=Ee.call(h),Ee=0;!(Y=h.next()).done;)Y=Y.value,ie=Fe+Xe(Y,Ee++),de+=S(Y,T,X,ie,K);else if(ie==="object"){if(typeof h.then=="function")return S(fe(h),T,X,Y,K);throw T=String(h),Error("Objects are not valid as a React child (found: "+(T==="[object Object]"?"object with keys {"+Object.keys(h).join(", ")+"}":T)+"). If you meant to render a collection of children, use an array instead.")}return de}function O(h,T,X){if(h==null)return h;var Y=[],K=0;return S(h,Y,"","",function(ie){return T.call(X,ie,K++)}),Y}function Z(h){if(h._status===-1){var T=h._result;T=T(),T.then(function(X){(h._status===0||h._status===-1)&&(h._status=1,h._result=X)},function(X){(h._status===0||h._status===-1)&&(h._status=2,h._result=X)}),h._status===-1&&(h._status=0,h._result=T)}if(h._status===1)return h._result.default;throw h._result}var W=typeof reportError=="function"?reportError:function(h){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var T=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof h=="object"&&h!==null&&typeof h.message=="string"?String(h.message):String(h),error:h});if(!window.dispatchEvent(T))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",h);return}console.error(h)},re={map:O,forEach:function(h,T,X){O(h,function(){T.apply(this,arguments)},X)},count:function(h){var T=0;return O(h,function(){T++}),T},toArray:function(h){return O(h,function(T){return T})||[]},only:function(h){if(!Ae(h))throw Error("React.Children.only expected to receive a single React element child.");return h}};return oe.Activity=k,oe.Children=re,oe.Component=F,oe.Fragment=f,oe.Profiler=y,oe.PureComponent=g,oe.StrictMode=c,oe.Suspense=A,oe.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=ae,oe.__COMPILER_RUNTIME={__proto__:null,c:function(h){return ae.H.useMemoCache(h)}},oe.cache=function(h){return function(){return h.apply(null,arguments)}},oe.cacheSignal=function(){return null},oe.cloneElement=function(h,T,X){if(h==null)throw Error("The argument must be a React element, but you passed "+h+".");var Y=ee({},h.props),K=h.key;if(T!=null)for(ie in T.key!==void 0&&(K=""+T.key),T)!je.call(T,ie)||ie==="key"||ie==="__self"||ie==="__source"||ie==="ref"&&T.ref===void 0||(Y[ie]=T[ie]);var ie=arguments.length-2;if(ie===1)Y.children=X;else if(1<ie){for(var de=Array(ie),Fe=0;Fe<ie;Fe++)de[Fe]=arguments[Fe+2];Y.children=de}return Se(h.type,K,Y)},oe.createContext=function(h){return h={$$typeof:w,_currentValue:h,_currentValue2:h,_threadCount:0,Provider:null,Consumer:null},h.Provider=h,h.Consumer={$$typeof:b,_context:h},h},oe.createElement=function(h,T,X){var Y,K={},ie=null;if(T!=null)for(Y in T.key!==void 0&&(ie=""+T.key),T)je.call(T,Y)&&Y!=="key"&&Y!=="__self"&&Y!=="__source"&&(K[Y]=T[Y]);var de=arguments.length-2;if(de===1)K.children=X;else if(1<de){for(var Fe=Array(de),Ee=0;Ee<de;Ee++)Fe[Ee]=arguments[Ee+2];K.children=Fe}if(h&&h.defaultProps)for(Y in de=h.defaultProps,de)K[Y]===void 0&&(K[Y]=de[Y]);return Se(h,ie,K)},oe.createRef=function(){return{current:null}},oe.forwardRef=function(h){return{$$typeof:q,render:h}},oe.isValidElement=Ae,oe.lazy=function(h){return{$$typeof:E,_payload:{_status:-1,_result:h},_init:Z}},oe.memo=function(h,T){return{$$typeof:m,type:h,compare:T===void 0?null:T}},oe.startTransition=function(h){var T=ae.T,X={};ae.T=X;try{var Y=h(),K=ae.S;K!==null&&K(X,Y),typeof Y=="object"&&Y!==null&&typeof Y.then=="function"&&Y.then(ge,W)}catch(ie){W(ie)}finally{T!==null&&X.types!==null&&(T.types=X.types),ae.T=T}},oe.unstable_useCacheRefresh=function(){return ae.H.useCacheRefresh()},oe.use=function(h){return ae.H.use(h)},oe.useActionState=function(h,T,X){return ae.H.useActionState(h,T,X)},oe.useCallback=function(h,T){return ae.H.useCallback(h,T)},oe.useContext=function(h){return ae.H.useContext(h)},oe.useDebugValue=function(){},oe.useDeferredValue=function(h,T){return ae.H.useDeferredValue(h,T)},oe.useEffect=function(h,T){return ae.H.useEffect(h,T)},oe.useEffectEvent=function(h){return ae.H.useEffectEvent(h)},oe.useId=function(){return ae.H.useId()},oe.useImperativeHandle=function(h,T,X){return ae.H.useImperativeHandle(h,T,X)},oe.useInsertionEffect=function(h,T){return ae.H.useInsertionEffect(h,T)},oe.useLayoutEffect=function(h,T){return ae.H.useLayoutEffect(h,T)},oe.useMemo=function(h,T){return ae.H.useMemo(h,T)},oe.useOptimistic=function(h,T){return ae.H.useOptimistic(h,T)},oe.useReducer=function(h,T,X){return ae.H.useReducer(h,T,X)},oe.useRef=function(h){return ae.H.useRef(h)},oe.useState=function(h){return ae.H.useState(h)},oe.useSyncExternalStore=function(h,T,X){return ae.H.useSyncExternalStore(h,T,X)},oe.useTransition=function(){return ae.H.useTransition()},oe.version="19.2.8",oe}var Jp;function Zs(){return Jp||(Jp=1,Gs.exports=Ym()),Gs.exports}var Hs={exports:{}},ht={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Wp;function Xm(){if(Wp)return ht;Wp=1;var u=Zs();function p(A){var m="https://react.dev/errors/"+A;if(1<arguments.length){m+="?args[]="+encodeURIComponent(arguments[1]);for(var E=2;E<arguments.length;E++)m+="&args[]="+encodeURIComponent(arguments[E])}return"Minified React error #"+A+"; visit "+m+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function f(){}var c={d:{f,r:function(){throw Error(p(522))},D:f,C:f,L:f,m:f,X:f,S:f,M:f},p:0,findDOMNode:null},y=Symbol.for("react.portal");function b(A,m,E){var k=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:y,key:k==null?null:""+k,children:A,containerInfo:m,implementation:E}}var w=u.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function q(A,m){if(A==="font")return"";if(typeof m=="string")return m==="use-credentials"?m:""}return ht.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=c,ht.createPortal=function(A,m){var E=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!m||m.nodeType!==1&&m.nodeType!==9&&m.nodeType!==11)throw Error(p(299));return b(A,m,null,E)},ht.flushSync=function(A){var m=w.T,E=c.p;try{if(w.T=null,c.p=2,A)return A()}finally{w.T=m,c.p=E,c.d.f()}},ht.preconnect=function(A,m){typeof A=="string"&&(m?(m=m.crossOrigin,m=typeof m=="string"?m==="use-credentials"?m:"":void 0):m=null,c.d.C(A,m))},ht.prefetchDNS=function(A){typeof A=="string"&&c.d.D(A)},ht.preinit=function(A,m){if(typeof A=="string"&&m&&typeof m.as=="string"){var E=m.as,k=q(E,m.crossOrigin),B=typeof m.integrity=="string"?m.integrity:void 0,L=typeof m.fetchPriority=="string"?m.fetchPriority:void 0;E==="style"?c.d.S(A,typeof m.precedence=="string"?m.precedence:void 0,{crossOrigin:k,integrity:B,fetchPriority:L}):E==="script"&&c.d.X(A,{crossOrigin:k,integrity:B,fetchPriority:L,nonce:typeof m.nonce=="string"?m.nonce:void 0})}},ht.preinitModule=function(A,m){if(typeof A=="string")if(typeof m=="object"&&m!==null){if(m.as==null||m.as==="script"){var E=q(m.as,m.crossOrigin);c.d.M(A,{crossOrigin:E,integrity:typeof m.integrity=="string"?m.integrity:void 0,nonce:typeof m.nonce=="string"?m.nonce:void 0})}}else m==null&&c.d.M(A)},ht.preload=function(A,m){if(typeof A=="string"&&typeof m=="object"&&m!==null&&typeof m.as=="string"){var E=m.as,k=q(E,m.crossOrigin);c.d.L(A,E,{crossOrigin:k,integrity:typeof m.integrity=="string"?m.integrity:void 0,nonce:typeof m.nonce=="string"?m.nonce:void 0,type:typeof m.type=="string"?m.type:void 0,fetchPriority:typeof m.fetchPriority=="string"?m.fetchPriority:void 0,referrerPolicy:typeof m.referrerPolicy=="string"?m.referrerPolicy:void 0,imageSrcSet:typeof m.imageSrcSet=="string"?m.imageSrcSet:void 0,imageSizes:typeof m.imageSizes=="string"?m.imageSizes:void 0,media:typeof m.media=="string"?m.media:void 0})}},ht.preloadModule=function(A,m){if(typeof A=="string")if(m){var E=q(m.as,m.crossOrigin);c.d.m(A,{as:typeof m.as=="string"&&m.as!=="script"?m.as:void 0,crossOrigin:E,integrity:typeof m.integrity=="string"?m.integrity:void 0})}else c.d.m(A)},ht.requestFormReset=function(A){c.d.r(A)},ht.unstable_batchedUpdates=function(A,m){return A(m)},ht.useFormState=function(A,m,E){return w.H.useFormState(A,m,E)},ht.useFormStatus=function(){return w.H.useHostTransitionStatus()},ht.version="19.2.8",ht}var $p;function Pm(){if($p)return Hs.exports;$p=1;function u(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(u)}catch(p){console.error(p)}}return u(),Hs.exports=Xm(),Hs.exports}/**
 * @license React
...
void main() {
  ...
  if (hit) {
    ...
    // Orbit trap direct coloring: fine fractal structure modulates material (Syntopia/IQ technique)
    float trapWeight = clamp(0.25 / (1.0 + min_trap * 3.0), 0.0, 0.35);
    mat_col = mix(mat_col, u_accent_color * (0.6 + trapDetail * 0.4), trapWeight);
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ch=R.forwardRef(({color:u="currentColor",size:p=24,strokeWidth:f=2,absoluteStrokeWidth:c,className:y="",children:b,iconNode:w,...q},A)=>R.createElement("svg",{ref:A,...sh,width:p,height:p,stroke:u,strokeWidth:c?Number(f)*24/Number(p):f,className:hf("lucide",y),...!b&&!oh(q)&&{"aria-hidden":"true"},...q},[...w.map(([m,E])=>R.createElement(m,E)),...Array.isArray(b)?b:[b]]));/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
