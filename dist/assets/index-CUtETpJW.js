 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Qp;function Bm(){return Qp||(Qp=1,(function(p){function s(w,F){var M=w.length;w.push(F);e:for(;0<M;){var Z=M-1>>>1,$=w[Z];if(0<g($,F))w[Z]=F,w[M]=$,M=Z;else break e}}function f(w){return w.length===0?null:w[0]}function u(w){if(w.length===0)return null;var F=w[0],M=w.pop();if(M!==F){w[0]=M;e:for(var Z=0,$=w.length,d=$>>>1;Z<d;){var C=2*(Z+1)-1,H=w[C],Q=C+1,ie=w[Q];if(0>g(H,M))Q<$&&0>g(ie,H)?(w[Z]=ie,w[Q]=M,Z=Q):(w[Z]=H,w[C]=M,Z=C);else if(Q<$&&0>g(ie,M))w[Z]=ie,w[Q]=M,Z=Q;else break e}}return F}function g(w,F){var M=w.sortIndex-F.sortIndex;return M!==0?M:w.id-F.id}if(p.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var b=performance;p.unstable_now=function(){return b.now()}}else{var x=Date,j=x.now();p.unstable_now=function(){return x.now()-j}}var N=[],v=[],B=1,E=null,G=3,U=!1,P=!1,W=!1,J=!1,L=typeof setTimeout=="function"?setTimeout:null,ue=typeof clearTimeout=="function"?clearTimeout:null,_=typeof setImmediate<"u"?setImmediate:null;function Y(w){for(var F=f(v);F!==null;){if(F.callback===null)u(v);else if(F.startTime<=w)u(v),F.sortIndex=F.expirationTime,s(N,F);else break;F=f(v)}}function xe(w){if(W=!1,Y(w),!P)if(f(N)!==null)P=!0,je||(je=!0,Xe());else{var F=f(v);F!==null&&se(xe,F.startTime-w)}}var je=!1,te=-1,Fe=5,Le=-1;function He(){return J?!0:!(p.unstable_now()-Le<Fe)}function Qe(){if(J=!1,je){var w=p.unstable_now();Le=w;var F=!0;try{e:{P=!1,W&&(W=!1,ue(te),te=-1),U=!0;var M=G;try{t:{for(Y(w),E=f(N);E!==null&&!(E.expirationTime>w&&He());){var Z=E.callback;if(typeof Z=="function"){E.callback=null,G=E.priorityLevel;var $=Z(E.expirationTime<=w);if(w=p.unstable_now(),typeof $=="function"){E.callback=$,Y(w),F=!0;break t}E===f(N)&&u(N),Y(w)}else u(N);E=f(N)}if(E!==null)F=!0;else{var d=f(v);d!==null&&se(xe,d.startTime-w),F=!1}}break e}finally{E=null,G=M,U=!1}F=void 0}}finally{F?Xe():je=!1}}}var Xe;if(typeof _=="function")Xe=function(){_(Qe)};else if(typeof MessageChannel<"u"){var pe=new MessageChannel,Be=pe.port2;pe.port1.onmessage=Qe,Xe=function(){Be.postMessage(null)}}else Xe=function(){L(Qe,0)};function se(w,F){te=L(function(){w(p.unstable_now())},F)}p.unstable_IdlePriority=5,p.unstable_ImmediatePriority=1,p.unstable_LowPriority=4,p.unstable_NormalPriority=3,p.unstable_Profiling=null,p.unstable_UserBlockingPriority=2,p.unstable_cancelCallback=function(w){w.callback=null},p.unstable_forceFrameRate=function(w){0>w||125<w?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Fe=0<w?Math.floor(1e3/w):5},p.unstable_getCurrentPriorityLevel=function(){return G},p.unstable_next=function(w){switch(G){case 1:case 2:case 3:var F=3;break;default:F=G}var M=G;G=F;try{return w()}finally{G=M}},p.unstable_requestPaint=function(){J=!0},p.unstable_runWithPriority=function(w,F){switch(w){case 1:case 2:case 3:case 4:case 5:break;default:w=3}var M=G;G=w;try{return F()}finally{G=M}},p.unstable_scheduleCallback=function(w,F,M){var Z=p.unstable_now();switch(typeof M=="object"&&M!==null?(M=M.delay,M=typeof M=="number"&&0<M?Z+M:Z):M=Z,w){case 1:var $=-1;break;case 2:$=250;break;case 5:$=1073741823;break;case 4:$=1e4;break;default:$=5e3}return $=M+$,w={id:B++,callback:F,priorityLevel:w,startTime:M,expirationTime:$,sortIndex:-1},M>Z?(w.sortIndex=M,s(v,w),f(N)===null&&w===f(v)&&(W?(ue(te),te=-1):W=!0,se(xe,M-Z))):(w.sortIndex=$,s(N,w),P||U||(P=!0,je||(je=!0,Xe()))),w},p.unstable_shouldYield=He,p.unstable_wrapCallback=function(w){var F=G;return function(){var M=G;G=F;try{return w.apply(this,arguments)}finally{G=M}}}})(Vs)),Vs}var Ip;function Um(){return Ip||(Ip=1,Xs.exports=Bm()),Xs.exports}var Zs={exports:{}},ne={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
