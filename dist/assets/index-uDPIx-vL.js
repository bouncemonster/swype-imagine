 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var nf;function Qm(){return nf||(nf=1,(function(u){function s(A,q){var T=A.length;A.push(q);e:for(;0<T;){var Z=T-1>>>1,J=A[Z];if(0<d(J,q))A[Z]=q,A[T]=J,T=Z;else break e}}function f(A){return A.length===0?null:A[0]}function c(A){if(A.length===0)return null;var q=A[0],T=A.pop();if(T!==q){A[0]=T;e:for(var Z=0,J=A.length,h=J>>>1;Z<h;){var M=2*(Z+1)-1,G=A[M],X=M+1,$=A[X];if(0>d(G,T))X<J&&0>d($,G)?(A[Z]=$,A[X]=T,Z=X):(A[Z]=G,A[M]=T,Z=M);else if(X<J&&0>d($,T))A[Z]=$,A[X]=T,Z=X;else break e}}return q}function d(A,q){var T=A.sortIndex-q.sortIndex;return T!==0?T:A.id-q.id}if(u.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var m=performance;u.unstable_now=function(){return m.now()}}else{var z=Date,b=z.now();u.unstable_now=function(){return z.now()-b}}var g=[],y=[],H=1,F=null,B=3,L=!1,Y=!1,K=!1,W=!1,U=typeof setTimeout=="function"?setTimeout:null,oe=typeof clearTimeout=="function"?clearTimeout:null,S=typeof setImmediate<"u"?setImmediate:null;function P(A){for(var q=f(y);q!==null;){if(q.callback===null)c(y);else if(q.startTime<=A)c(y),q.sortIndex=q.expirationTime,s(g,q);else break;q=f(y)}}function ge(A){if(K=!1,P(A),!Y)if(f(g)!==null)Y=!0,Ae||(Ae=!0,Ke());else{var q=f(y);q!==null&&ue(ge,q.startTime-A)}}var Ae=!1,ae=-1,qe=5,Ye=-1;function Ve(){return W?!0:!(u.unstable_now()-Ye<qe)}function et(){if(W=!1,Ae){var A=u.unstable_now();Ye=A;var q=!0;try{e:{Y=!1,K&&(K=!1,oe(ae),ae=-1),L=!0;var T=B;try{t:{for(P(A),F=f(g);F!==null&&!(F.expirationTime>A&&Ve());){var Z=F.callback;if(typeof Z=="function"){F.callback=null,B=F.priorityLevel;var J=Z(F.expirationTime<=A);if(A=u.unstable_now(),typeof J=="function"){F.callback=J,P(A),q=!0;break t}F===f(g)&&c(g),P(A)}else c(g);F=f(g)}if(F!==null)q=!0;else{var h=f(y);h!==null&&ue(ge,h.startTime-A),q=!1}}break e}finally{F=null,B=T,L=!1}q=void 0}}finally{q?Ke():Ae=!1}}}var Ke;if(typeof S=="function")Ke=function(){S(et)};else if(typeof MessageChannel<"u"){var de=new MessageChannel,Le=de.port2;de.port1.onmessage=et,Ke=function(){Le.postMessage(null)}}else Ke=function(){U(et,0)};function ue(A,q){ae=U(function(){A(u.unstable_now())},q)}u.unstable_IdlePriority=5,u.unstable_ImmediatePriority=1,u.unstable_LowPriority=4,u.unstable_NormalPriority=3,u.unstable_Profiling=null,u.unstable_UserBlockingPriority=2,u.unstable_cancelCallback=function(A){A.callback=null},u.unstable_forceFrameRate=function(A){0>A||125<A?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):qe=0<A?Math.floor(1e3/A):5},u.unstable_getCurrentPriorityLevel=function(){return B},u.unstable_next=function(A){switch(B){case 1:case 2:case 3:var q=3;break;default:q=B}var T=B;B=q;try{return A()}finally{B=T}},u.unstable_requestPaint=function(){W=!0},u.unstable_runWithPriority=function(A,q){switch(A){case 1:case 2:case 3:case 4:case 5:break;default:A=3}var T=B;B=A;try{return q()}finally{B=T}},u.unstable_scheduleCallback=function(A,q,T){var Z=u.unstable_now();switch(typeof T=="object"&&T!==null?(T=T.delay,T=typeof T=="number"&&0<T?Z+T:Z):T=Z,A){case 1:var J=-1;break;case 2:J=250;break;case 5:J=1073741823;break;case 4:J=1e4;break;default:J=5e3}return J=T+J,A={id:H++,callback:q,priorityLevel:A,startTime:T,expirationTime:J,sortIndex:-1},T>Z?(A.sortIndex=T,s(y,A),f(g)===null&&A===f(y)&&(K?(oe(ae),ae=-1):K=!0,ue(ge,T-Z))):(A.sortIndex=J,s(g,A),Y||L||(Y=!0,Ae||(Ae=!0,Ke()))),A},u.unstable_shouldYield=Ve,u.unstable_wrapCallback=function(A){var q=B;return function(){var T=B;B=q;try{return A.apply(this,arguments)}finally{B=T}}}})(ec)),ec}var lf;function Jm(){return lf||(lf=1,$s.exports=Qm()),$s.exports}var tc={exports:{}},se={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
