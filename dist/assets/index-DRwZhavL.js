 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Jp;function Gm(){return Jp||(Jp=1,(function(p){function s(N,F){var M=N.length;N.push(F);e:for(;0<M;){var I=M-1>>>1,ee=N[I];if(0<d(ee,F))N[I]=F,N[M]=ee,M=I;else break e}}function f(N){return N.length===0?null:N[0]}function c(N){if(N.length===0)return null;var F=N[0],M=N.pop();if(M!==F){N[0]=M;e:for(var I=0,ee=N.length,h=ee>>>1;I<h;){var C=2*(I+1)-1,G=N[C],X=C+1,$=N[X];if(0>d(G,M))X<ee&&0>d($,G)?(N[I]=$,N[X]=M,I=X):(N[I]=G,N[C]=M,I=C);else if(X<ee&&0>d($,M))N[I]=$,N[X]=M,I=X;else break e}}return F}function d(N,F){var M=N.sortIndex-F.sortIndex;return M!==0?M:N.id-F.id}if(p.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var v=performance;p.unstable_now=function(){return v.now()}}else{var A=Date,_=A.now();p.unstable_now=function(){return A.now()-_}}var b=[],g=[],H=1,k=null,U=3,B=!1,Y=!1,K=!1,J=!1,L=typeof setTimeout=="function"?setTimeout:null,le=typeof clearTimeout=="function"?clearTimeout:null,z=typeof setImmediate<"u"?setImmediate:null;function V(N){for(var F=f(g);F!==null;){if(F.callback===null)c(g);else if(F.startTime<=N)c(g),F.sortIndex=F.expirationTime,s(b,F);else break;F=f(g)}}function ve(N){if(K=!1,V(N),!Y)if(f(b)!==null)Y=!0,je||(je=!0,Pe());else{var F=f(g);F!==null&&fe(ve,F.startTime-N)}}var je=!1,ie=-1,Fe=5,Ge=-1;function Ye(){return J?!0:!(p.unstable_now()-Ge<Fe)}function Ke(){if(J=!1,je){var N=p.unstable_now();Ge=N;var F=!0;try{e:{Y=!1,K&&(K=!1,le(ie),ie=-1),B=!0;var M=U;try{t:{for(V(N),k=f(b);k!==null&&!(k.expirationTime>N&&Ye());){var I=k.callback;if(typeof I=="function"){k.callback=null,U=k.priorityLevel;var ee=I(k.expirationTime<=N);if(N=p.unstable_now(),typeof ee=="function"){k.callback=ee,V(N),F=!0;break t}k===f(b)&&c(b),V(N)}else c(b);k=f(b)}if(k!==null)F=!0;else{var h=f(g);h!==null&&fe(ve,h.startTime-N),F=!1}}break e}finally{k=null,U=M,B=!1}F=void 0}}finally{F?Pe():je=!1}}}var Pe;if(typeof z=="function")Pe=function(){z(Ke)};else if(typeof MessageChannel<"u"){var me=new MessageChannel,He=me.port2;me.port1.onmessage=Ke,Pe=function(){He.postMessage(null)}}else Pe=function(){L(Ke,0)};function fe(N,F){ie=L(function(){N(p.unstable_now())},F)}p.unstable_IdlePriority=5,p.unstable_ImmediatePriority=1,p.unstable_LowPriority=4,p.unstable_NormalPriority=3,p.unstable_Profiling=null,p.unstable_UserBlockingPriority=2,p.unstable_cancelCallback=function(N){N.callback=null},p.unstable_forceFrameRate=function(N){0>N||125<N?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Fe=0<N?Math.floor(1e3/N):5},p.unstable_getCurrentPriorityLevel=function(){return U},p.unstable_next=function(N){switch(U){case 1:case 2:case 3:var F=3;break;default:F=U}var M=U;U=F;try{return N()}finally{U=M}},p.unstable_requestPaint=function(){J=!0},p.unstable_runWithPriority=function(N,F){switch(N){case 1:case 2:case 3:case 4:case 5:break;default:N=3}var M=U;U=N;try{return F()}finally{U=M}},p.unstable_scheduleCallback=function(N,F,M){var I=p.unstable_now();switch(typeof M=="object"&&M!==null?(M=M.delay,M=typeof M=="number"&&0<M?I+M:I):M=I,N){case 1:var ee=-1;break;case 2:ee=250;break;case 5:ee=1073741823;break;case 4:ee=1e4;break;default:ee=5e3}return ee=M+ee,N={id:H++,callback:F,priorityLevel:N,startTime:M,expirationTime:ee,sortIndex:-1},M>I?(N.sortIndex=M,s(g,N),f(b)===null&&N===f(g)&&(K?(le(ie),ie=-1):K=!0,fe(ve,M-I))):(N.sortIndex=ee,s(b,N),Y||B||(Y=!0,je||(je=!0,Pe()))),N},p.unstable_shouldYield=Ye,p.unstable_wrapCallback=function(N){var F=U;return function(){var M=U;U=F;try{return N.apply(this,arguments)}finally{U=M}}}})(Qs)),Qs}var $p;function Ym(){return $p||($p=1,Is.exports=Gm()),Is.exports}var Ks={exports:{}},re={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var ef;function Vm(){if(ef)return re;ef=1;var p=Symbol.for("react.transitional.element"),s=Symbol.for("react.portal"),f=Symbol.for("react.fragment"),c=Symbol.for("react.strict_mode"),d=Symbol.for("react.profiler"),v=Symbol.for("react.consumer"),A=Symbol.for("react.context"),_=Symbol.for("react.forward_ref"),b=Symbol.for("react.suspense"),g=Symbol.for("react.memo"),H=Symbol.for("react.lazy"),k=Symbol.for("react.activity"),U=Symbol.iterator;function B(h){return h===null||typeof h!="object"?null:(h=U&&h[U]||h["@@iterator"],typeof h=="function"?h:null)}var Y={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},K=Object.assign,J={};function L(h,C,G){this.props=h,this.context=C,this.refs=J,this.updater=G||Y}L.prototype.isReactComponent={},L.prototype.setState=function(h,C){if(typeof h!="object"&&typeof h!="function"&&h!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,h,C,"setState")},L.prototype.forceUpdate=function(h){this.updater.enqueueForceUpdate(this,h,"forceUpdate")};function le(){}le.prototype=L.prototype;function z(h,C,G){this.props=h,this.context=C,this.refs=J,this.updater=G||Y}var V=z.prototype=new le;V.constructor=z,K(V,L.prototype),V.isPureReactComponent=!0;var ve=Array.isArray;function je(){}var ie={H:null,A:null,T:null,S:null},Fe=Object.prototype.hasOwnProperty;function Ge(h,C,G){var X=G.ref;return{$$typeof:p,type:h,key:C,ref:X!==void 0?X:null,props:G}}function Ye(h,C){return Ge(h.type,C,h.props)}function Ke(h){return typeof h=="object"&&h!==null&&h.$$typeof===p}function Pe(h){var C={"=":"=0",":":"=2"};return"$"+h.replace(/[=:]/g,function(G){return C[G]})}var me=/\/+/g;function He(h,C){return typeof h=="object"&&h!==null&&h.key!=null?Pe(""+h.key):C.toString(36)}function fe(h){switch(h.status){case"fulfilled":return h.value;case"rejected":throw h.reason;default:switch(typeof h.status=="string"?h.then(je,je):(h.status="pending",h.then(function(C){h.status==="pending"&&(h.status="fulfilled",h.value=C)},function(C){h.status==="pending"&&(h.status="rejected",h.reason=C)})),h.status){case"fulfilled":return h.value;case"rejected":throw h.reason}}throw h}function N(h,C,G,X,$){var ae=typeof h;(ae==="undefined"||ae==="boolean")&&(h=null);var ue=!1;if(h===null)ue=!0;else switch(ae){case"bigint":case"string":case"number":ue=!0;break;case"object":switch(h.$$typeof){case p:case s:ue=!0;break;case H:return ue=h._init,N(ue(h._payload),C,G,X,$)}}if(ue)return $=$(h),ue=X===""?"."+He(h,0):X,ve($)?(G="",ue!=null&&(G=ue.replace(me,"$&/")+"/"),N($,C,G,"",function($e){return $e})):$!=null&&(Ke($)&&($=Ye($,G+($.key==null||h&&h.key===$.key?"":(""+$.key).replace(me,"$&/")+"/")+ue)),C.push($)),1;ue=0;var Ue=X===""?".":X+":";if(ve(h))for(var de=0;de<h.length;de++)X=h[de],ae=Ue+He(X,de),ue+=N(X,C,G,ae,$);else if(de=B(h),typeof de=="function")for(h=de.call(h),de=0;!(X=h.next()).done;)X=X.value,ae=Ue+He(X,de++),ue+=N(X,C,G,ae,$);else if(ae==="object"){if(typeof h.then=="function")return N(fe(h),C,G,X,$);throw C=String(h),Error("Objects are not valid as a React child (found: "+(C==="[object Object]"?"object with keys {"+Object.keys(h).join(", ")+"}":C)+"). If you meant to render a collection of children, use an array instead.")}return ue}function F(h,C,G){if(h==null)return h;var X=[],$=0;return N(h,X,"","",function(ae){return C.call(G,ae,$++)}),X}function M(h){if(h._status===-1){var C=h._result;C=C(),C.then(function(G){(h._status===0||h._status===-1)&&(h._status=1,h._result=G)},function(G){(h._status===0||h._status===-1)&&(h._status=2,h._result=G)}),h._status===-1&&(h._status=0,h._result=C)}if(h._status===1)return h._result.default;throw h._result}var I=typeof reportError=="function"?reportError:function(h){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var C=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof h=="object"&&h!==null&&typeof h.message=="string"?String(h.message):String(h),error:h});if(!window.dispatchEvent(C))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",h);return}console.error(h)},ee={map:F,forEach:function(h,C,G){F(h,function(){C.apply(this,arguments)},G)},count:function(h){var C=0;return F(h,function(){C++}),C},toArray:function(h){return F(h,function(C){return C})||[]},only:function(h){if(!Ke(h))throw Error("React.Children.only expected to receive a single React element child.");return h}};return re.Activity=k,re.Children=ee,re.Component=L,re.Fragment=f,re.Profiler=d,re.PureComponent=z,re.StrictMode=c,re.Suspense=b,re.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=ie,re.__COMPILER_RUNTIME={__proto__:null,c:function(h){return ie.H.useMemoCache(h)}},re.cache=function(h){return function(){return h.apply(null,arguments)}},re.cacheSignal=function(){return null},re.cloneElement=function(h,C,G){if(h==null)throw Error("The argument must be a React element, but you passed "+h+".");var X=K({},h.props),$=h.key;if(C!=null)for(ae in C.key!==void 0&&($=""+C.key),C)!Fe.call(C,ae)||ae==="key"||ae==="__self"||ae==="__source"||ae==="ref"&&C.ref===void 0||(X[ae]=C[ae]);var ae=arguments.length-2;if(ae===1)X.children=G;else if(1<ae){for(var ue=Array(ae),Ue=0;Ue<ae;Ue++)ue[Ue]=arguments[Ue+2];X.children=ue}return Ge(h.type,$,X)},re.createContext=function(h){return h={$$typeof:A,_currentValue:h,_currentValue2:h,_threadCount:0,Provider:null,Consumer:null},h.Provider=h,h.Consumer={$$typeof:v,_context:h},h},re.createElement=function(h,C,G){var X,$={},ae=null;if(C!=null)for(X in C.key!==void 0&&(ae=""+C.key),C)Fe.call(C,X)&&X!=="key"&&X!=="__self"&&X!=="__source"&&($[X]=C[X]);var ue=arguments.length-2;if(ue===1)$.children=G;else if(1<ue){for(var Ue=Array(ue),de=0;de<ue;de++)Ue[de]=arguments[de+2];$.children=Ue}if(h&&h.defaultProps)for(X in ue=h.defaultProps,ue)$[X]===void 0&&($[X]=ue[X]);return Ge(h,ae,$)},re.createRef=function(){return{current:null}},re.forwardRef=function(h){return{$$typeof:_,render:h}},re.isValidElement=Ke,re.lazy=function(h){return{$$typeof:H,_payload:{_status:-1,_result:h},_init:M}},re.memo=function(h,C){return{$$typeof:g,type:h,compare:C===void 0?null:C}},re.startTransition=function(h){var C=ie.T,G={};ie.T=G;try{var X=h(),$=ie.S;$!==null&&$(G,X),typeof X=="object"&&X!==null&&typeof X.then=="function"&&X.then(je,I)}catch(ae){I(ae)}finally{C!==null&&G.types!==null&&(C.types=G.types),ie.T=C}},re.unstable_useCacheRefresh=function(){return ie.H.useCacheRefresh()},re.use=function(h){return ie.H.use(h)},re.useActionState=function(h,C,G){return ie.H.useActionState(h,C,G)},re.useCallback=function(h,C){return ie.H.useCallback(h,C)},re.useContext=function(h){return ie.H.useContext(h)},re.useDebugValue=function(){},re.useDeferredValue=function(h,C){return ie.H.useDeferredValue(h,C)},re.useEffect=function(h,C){return ie.H.useEffect(h,C)},re.useEffectEvent=function(h){return ie.H.useEffectEvent(h)},re.useId=function(){return ie.H.useId()},re.useImperativeHandle=function(h,C,G){return ie.H.useImperativeHandle(h,C,G)},re.useInsertionEffect=function(h,C){return ie.H.useInsertionEffect(h,C)},re.useLayoutEffect=function(h,C){return ie.H.useLayoutEffect(h,C)},re.useMemo=function(h,C){return ie.H.useMemo(h,C)},re.useOptimistic=function(h,C){return ie.H.useOptimistic(h,C)},re.useReducer=function(h,C,G){return ie.H.useReducer(h,C,G)},re.useRef=function(h){return ie.H.useRef(h)},re.useState=function(h){return ie.H.useState(h)},re.useSyncExternalStore=function(h,C,G){return ie.H.useSyncExternalStore(h,C,G)},re.useTransition=function(){return ie.H.useTransition()},re.version="19.2.8",re}var tf;function ic(){return tf||(tf=1,Ks.exports=Vm()),Ks.exports}var Ws={exports:{}},gt={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var af;function Xm(){if(af)return gt;af=1;var p=ic();function s(b){var g="https://react.dev/errors/"+b;if(1<arguments.length){g+="?args[]="+encodeURIComponent(arguments[1]);for(var H=2;H<arguments.length;H++)g+="&args[]="+encodeURIComponent(arguments[H])}return"Minified React error #"+b+"; visit "+g+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function f(){}var c={d:{f,r:function(){throw Error(s(522))},D:f,C:f,L:f,m:f,X:f,S:f,M:f},p:0,findDOMNode:null},d=Symbol.for("react.portal");function v(b,g,H){var k=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:d,key:k==null?null:""+k,children:b,containerInfo:g,implementation:H}}var A=p.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function _(b,g){if(b==="font")return"";if(typeof g=="string")return g==="use-credentials"?g:""}return gt.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=c,gt.createPortal=function(b,g){var H=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!g||g.nodeType!==1&&g.nodeType!==9&&g.nodeType!==11)throw Error(s(299));return v(b,g,null,H)},gt.flushSync=function(b){var g=A.T,H=c.p;try{if(A.T=null,c.p=2,b)return b()}finally{A.T=g,c.p=H,c.d.f()}},gt.preconnect=function(b,g){typeof b=="string"&&(g?(g=g.crossOrigin,g=typeof g=="string"?g==="use-credentials"?g:"":void 0):g=null,c.d.C(b,g))},gt.prefetchDNS=function(b){typeof b=="string"&&c.d.D(b)},gt.preinit=function(b,g){if(typeof b=="string"&&g&&typeof g.as=="string"){var H=g.as,k=_(H,g.crossOrigin),U=typeof g.integrity=="string"?g.integrity:void 0,B=typeof g.fetchPriority=="string"?g.fetchPriority:void 0;H==="style"?c.d.S(b,typeof g.precedence=="string"?g.precedence:void 0,{crossOrigin:k,integrity:U,fetchPriority:B}):H==="script"&&c.d.X(b,{crossOrigin:k,integrity:U,fetchPriority:B,nonce:typeof g.nonce=="string"?g.nonce:void 0})}},gt.preinitModule=function(b,g){if(typeof b=="string")if(typeof g=="object"&&g!==null){if(g.as==null||g.as==="script"){var H=_(g.as,g.crossOrigin);c.d.M(b,{crossOrigin:H,integrity:typeof g.integrity=="string"?g.integrity:void 0,nonce:typeof g.nonce=="string"?g.nonce:void 0})}}else g==null&&c.d.M(b)},gt.preload=function(b,g){if(typeof b=="string"&&typeof g=="object"&&g!==null&&typeof g.as=="string"){var H=g.as,k=_(H,g.crossOrigin);c.d.L(b,H,{crossOrigin:k,integrity:typeof g.integrity=="string"?g.integrity:void 0,nonce:typeof g.nonce=="string"?g.nonce:void 0,type:typeof g.type=="string"?g.type:void 0,fetchPriority:typeof g.fetchPriority=="string"?g.fetchPriority:void 0,referrerPolicy:typeof g.referrerPolicy=="string"?g.referrerPolicy:void 0,imageSrcSet:typeof g.imageSrcSet=="string"?g.imageSrcSet:void 0,imageSizes:typeof g.imageSizes=="string"?g.imageSizes:void 0,media:typeof g.media=="string"?g.media:void 0})}},gt.preloadModule=function(b,g){if(typeof b=="string")if(g){var H=_(g.as,g.crossOrigin);c.d.m(b,{as:typeof g.as=="string"&&g.as!=="script"?g.as:void 0,crossOrigin:H,integrity:typeof g.integrity=="string"?g.integrity:void 0})}else c.d.m(b)},gt.requestFormReset=function(b){c.d.r(b)},gt.unstable_batchedUpdates=function(b,g){return b(g)},gt.useFormState=function(b,g,H){return A.H.useFormState(b,g,H)},gt.useFormStatus=function(){return A.H.useHostTransitionStatus()},gt.version="19.2.8",gt}var nf;function Pm(){if(nf)return Ws.exports;nf=1;function p(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(p)}catch(s){console.error(s)}}return p(),Ws.exports=Xm(),Ws.exports}/**
 * @license React
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const xh=R.forwardRef(({color:p="currentColor",size:s=24,strokeWidth:f=2,absoluteStrokeWidth:c,className:d="",children:v,iconNode:A,..._},b)=>R.createElement("svg",{ref:b,...hh,width:s,height:s,stroke:p,strokeWidth:c?Number(f)*24/Number(s):f,className:vf("lucide",d),...!v&&!mh(_)&&{"aria-hidden":"true"},..._},[...A.map(([g,H])=>R.createElement(g,H)),...Array.isArray(v)?v:[v]]));/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const bh=[["circle",{cx:"12",cy:"12",r:"1",key:"41hilf"}],["path",{d:"M20.2 20.2c2.04-2.03.02-7.36-4.5-11.9-4.54-4.52-9.87-6.54-11.9-4.5-2.04 2.03-.02 7.36 4.5 11.9 4.54 4.52 9.87 6.54 11.9 4.5Z",key:"1l2ple"}],["path",{d:"M15.7 15.7c4.52-4.54 6.54-9.87 4.5-11.9-2.03-2.04-7.36-.02-11.9 4.5-4.52 4.54-6.54 9.87-4.5 11.9 2.03 2.04 7.36.02 11.9-4.5Z",key:"1wam0m"}]],bf=ce("atom",bh);/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const gh=[["path",{d:"M12 7v14",key:"1akyts"}],["path",{d:"M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z",key:"ruj8y"}]],_n=ce("book-open",gh);/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Th=[["path",{d:"M20 6 9 17l-5-5",key:"1gmf2c"}]],gf=ce("check",Th);/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Yh=[["circle",{cx:"12",cy:"12",r:"1",key:"41hilf"}],["circle",{cx:"19",cy:"12",r:"1",key:"1wjl8i"}],["circle",{cx:"5",cy:"12",r:"1",key:"1pcz8c"}]],Vh=ce("ellipsis",Yh);/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Xh=[["path",{d:"M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0",key:"1nclc0"}],["circle",{cx:"12",cy:"12",r:"3",key:"1v7zrd"}]],zf=ce("eye",Xh);/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ph=[["path",{d:"M12 3q1 4 4 6.5t3 5.5a1 1 0 0 1-14 0 5 5 0 0 1 1-3 1 1 0 0 0 5 0c0-2-1.5-3-1.5-5q0-2 2.5-4",key:"1slcih"}]],Zh=ce("flame",Ph);/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const b2=[["path",{d:"M10 11v6",key:"nco0om"}],["path",{d:"M14 11v6",key:"outv1u"}],["path",{d:"M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6",key:"miytrc"}],["path",{d:"M3 6h18",key:"d0wm0j"}],["path",{d:"M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2",key:"e791ji"}]],g2=ce("trash-2",b2);/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
